...
void createBoundingProcess() {
  ...
  7b:	6a 02                	push   $0x2
  7d:	e8 1e 04 00 00       	call   4a0 <printf>
 ...
 409:	85 d2                	test   %edx,%edx
{
 ...
 470:	e8 c2 fe ff ff       	call   337 <write>
...
printf(int fd, const char *fmt, ...)
{
 ...
 4e0:	e8 52 fe ff ff       	call   337 <write>
 ...
 541:	e8 f1 fd ff ff       	call   337 <write>
 ...
 558:	31 ff                	xor    %edi,%edi
  write(fd, &c, 1);
 55a:	e8 d8 fd ff ff       	call   337 <write>
  for(i = 0; fmt[i]; i++){
 ...
 5f3:	57                   	push   %edi
 5f4:	53                   	push   %ebx
 5f5:	e8 3d fd ff ff       	call   337 <write>
        while(*s != 0){
 ...
 647:	e8 eb fc ff ff       	call   337 <write>
        ap++;
 ...
 654:	e9 8f fe ff ff       	jmp    4e8 <printf+0x48>
          s = "(null)";
 659:	bb 04 08 00 00       	mov    $0x804,%ebx
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 75e:	56                   	push   %esi
 75f:	e8 3b fc ff ff       	call   39f <sbrk>
  if(p == (char*)-1)
