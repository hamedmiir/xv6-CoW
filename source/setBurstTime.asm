...
000003df <getNumFreePages>:
 3df:	b8 1d 00 00 00       	mov    $0x1d,%eax
 3e4:	cd 40                	int    $0x40
 3e6:	c3                   	ret    
 ...
 3f9:	85 d2                	test   %edx,%edx
{
 ...
 460:	e8 c2 fe ff ff       	call   327 <write>
...
printf(int fd, const char *fmt, ...)
{
 ...
 4d0:	e8 52 fe ff ff       	call   327 <write>
 ...
 531:	e8 f1 fd ff ff       	call   327 <write>
 ...
 548:	31 ff                	xor    %edi,%edi
  write(fd, &c, 1);
 54a:	e8 d8 fd ff ff       	call   327 <write>
  for(i = 0; fmt[i]; i++){
 ...
 5e3:	57                   	push   %edi
 5e4:	53                   	push   %ebx
 5e5:	e8 3d fd ff ff       	call   327 <write>
        while(*s != 0){
 ...
 637:	e8 eb fc ff ff       	call   327 <write>
        ap++;
 ...
 644:	e9 8f fe ff ff       	jmp    4d8 <printf+0x48>
          s = "(null)";
 649:	bb 09 08 00 00       	mov    $0x809,%ebx
        while(*s != 0){
 ...
 661:	a1 e0 0a 00 00       	mov    0xae0,%eax
{
 ...
 69d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 69f:	a3 e0 0a 00 00       	mov    %eax,0xae0
}
 6a4:	5b                   	pop    %ebx
 6a5:	5e                   	pop    %esi
 6a6:	5f                   	pop    %edi
 ...
 6b6:	72 ce                	jb     686 <free+0x26>
{
 ...
 6d7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 6da:	a3 e0 0a 00 00       	mov    %eax,0xae0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 74e:	56                   	push   %esi
 74f:	e8 3b fc ff ff       	call   38f <sbrk>
  if(p == (char*)-1)
 ...
 7b7:	0a 00 00 
 7ba:	c7 05 e4 0a 00 00 e4 	movl   $0xae4,0xae4
 7c1:	0a 00 00 
    base.s.size = 0;
 7c4:	b8 e4 0a 00 00       	mov    $0xae4,%eax
 7c9:	c7 05 e8 0a 00 00 00 	movl   $0x0,0xae8
 7d0:	00 00 00 
