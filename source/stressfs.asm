 ...
 4b9:	85 d2                	test   %edx,%edx
{
 ...
 520:	e8 c2 fe ff ff       	call   3e7 <write>
...
printf(int fd, const char *fmt, ...)
{
 ...
 590:	e8 52 fe ff ff       	call   3e7 <write>
 ...
 5f1:	e8 f1 fd ff ff       	call   3e7 <write>
 ...
 608:	31 ff                	xor    %edi,%edi
  write(fd, &c, 1);
 60a:	e8 d8 fd ff ff       	call   3e7 <write>
  for(i = 0; fmt[i]; i++){
 ...
 6a3:	57                   	push   %edi
 6a4:	53                   	push   %ebx
 6a5:	e8 3d fd ff ff       	call   3e7 <write>
        while(*s != 0){
 ...
 6f7:	e8 eb fc ff ff       	call   3e7 <write>
        ap++;
...
free(void *ap)
{
 ...
 721:	a1 a8 0b 00 00       	mov    0xba8,%eax
{
 ...
 75d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 75f:	a3 a8 0b 00 00       	mov    %eax,0xba8
}
 764:	5b                   	pop    %ebx
 765:	5e                   	pop    %esi
 766:	5f                   	pop    %edi
 ...
 776:	72 ce                	jb     746 <free+0x26>
{
 ...
 797:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 79a:	a3 a8 0b 00 00       	mov    %eax,0xba8
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 7b9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 7bc:	8b 15 a8 0b 00 00    	mov    0xba8,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 826:	e8 f5 fe ff ff       	call   720 <free>
  return freep;
 82b:	8b 15 a8 0b 00 00    	mov    0xba8,%edx
 ...
 854:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 857:	89 15 a8 0b 00 00    	mov    %edx,0xba8
}
 ...
 869:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 870:	c7 05 a8 0b 00 00 ac 	movl   $0xbac,0xba8
 877:	0b 00 00 
 87a:	c7 05 ac 0b 00 00 ac 	movl   $0xbac,0xbac
 881:	0b 00 00 
    base.s.size = 0;
 884:	b8 ac 0b 00 00       	mov    $0xbac,%eax
 889:	c7 05 b0 0b 00 00 00 	movl   $0x0,0xbb0
 890:	00 00 00 
