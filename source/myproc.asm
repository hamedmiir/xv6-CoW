...
int main(int argc ,char* argv[])
{
  ...
  14:	53                   	push   %ebx
  15:	e8 18 03 00 00       	call   332 <incNum>
  ...
  25:	e8 e6 03 00 00       	call   410 <printf>
    getprocs();
  2a:	e8 0b 03 00 00       	call   33a <getprocs>
...
printf(int fd, const char *fmt, ...)
{
 ...
 5c4:	e9 8f fe ff ff       	jmp    458 <printf+0x48>
          s = "(null)";
 5c9:	bb 7e 07 00 00       	mov    $0x77e,%ebx
        while(*s != 0){
