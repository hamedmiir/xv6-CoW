   ...
   7:	83 39 03             	cmpl   $0x3,(%ecx)
{
  ...
  20:	e8 4b 04 00 00       	call   470 <printf>
    exit();
  25:	e8 bd 02 00 00       	call   2e7 <exit>
  }
  ...
  32:	e8 10 03 00 00       	call   347 <link>
  37:	83 c4 10             	add    $0x10,%esp
  3a:	85 c0                	test   %eax,%eax
  3c:	78 05                	js     43 <main+0x43>
    printf(2, "link %s %s: failed\n", argv[1], argv[2]);
  exit();
  3e:	e8 a4 02 00 00       	call   2e7 <exit>
    printf(2, "link %s %s: failed\n", argv[1], argv[2]);
 ...
 178:	89 f3                	mov    %esi,%ebx
{
 ...
 190:	50                   	push   %eax
 191:	6a 00                	push   $0x0
 193:	e8 67 01 00 00       	call   2ff <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 1fd:	e8 25 01 00 00       	call   327 <open>
  if(fd < 0)
 ...
 211:	50                   	push   %eax
 212:	e8 28 01 00 00       	call   33f <fstat>
  close(fd);
 217:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 21a:	89 c6                	mov    %eax,%esi
  close(fd);
 21c:	e8 ee 00 00 00       	call   30f <close>
  return r;
...
void delay(int numberOfClocks)
{
 ...
 2b7:	e8 c3 00 00 00       	call   37f <uptime>
 2bc:	89 c3                	mov    %eax,%ebx
    int incClock = uptime();
 2be:	e8 bc 00 00 00       	call   37f <uptime>
    while(incClock >= (firstClock + numberOfClocks) )
 2c3:	03 5d 08             	add    0x8(%ebp),%ebx
 2c6:	39 d8                	cmp    %ebx,%eax
 2c8:	7c 0f                	jl     2d9 <delay+0x29>
 2ca:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    {
        incClock = uptime();
 2d0:	e8 aa 00 00 00       	call   37f <uptime>
    while(incClock >= (firstClock + numberOfClocks) )
 2d5:	39 d8                	cmp    %ebx,%eax
 2d7:	7d f7                	jge    2d0 <delay+0x20>
    }
}
 2d9:	83 c4 04             	add    $0x4,%esp
 2dc:	5b                   	pop    %ebx
 2dd:	5d                   	pop    %ebp
 2de:	c3                   	ret    
 ...
 3d9:	85 d2                	test   %edx,%edx
{
 ...
 440:	e8 c2 fe ff ff       	call   307 <write>
...
printf(int fd, const char *fmt, ...)
{
 ...
 4b0:	e8 52 fe ff ff       	call   307 <write>
 ...
 511:	e8 f1 fd ff ff       	call   307 <write>
 ...
 528:	31 ff                	xor    %edi,%edi
  write(fd, &c, 1);
 52a:	e8 d8 fd ff ff       	call   307 <write>
  for(i = 0; fmt[i]; i++){
 ...
 5c3:	57                   	push   %edi
 5c4:	53                   	push   %ebx
 5c5:	e8 3d fd ff ff       	call   307 <write>
        while(*s != 0){
 ...
 617:	e8 eb fc ff ff       	call   307 <write>
        ap++;
...
free(void *ap)
{
 ...
 641:	a1 c4 0a 00 00       	mov    0xac4,%eax
{
 ...
 67d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 67f:	a3 c4 0a 00 00       	mov    %eax,0xac4
}
 684:	5b                   	pop    %ebx
 685:	5e                   	pop    %esi
 686:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 6d9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6dc:	8b 15 c4 0a 00 00    	mov    0xac4,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 71f:	73 47                	jae    768 <malloc+0x98>
    ...
    if(p == freep)
 721:	39 05 c4 0a 00 00    	cmp    %eax,0xac4
 727:	89 c2                	mov    %eax,%edx
 729:	75 ed                	jne    718 <malloc+0x48>
  p = sbrk(nu * sizeof(Header));
 72b:	83 ec 0c             	sub    $0xc,%esp
 72e:	56                   	push   %esi
 72f:	e8 3b fc ff ff       	call   36f <sbrk>
  if(p == (char*)-1)
 ...
 746:	e8 f5 fe ff ff       	call   640 <free>
  return freep;
 74b:	8b 15 c4 0a 00 00    	mov    0xac4,%edx
 ...
 774:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 777:	89 15 c4 0a 00 00    	mov    %edx,0xac4
}
 ...
 797:	0a 00 00 
 79a:	c7 05 c8 0a 00 00 c8 	movl   $0xac8,0xac8
 7a1:	0a 00 00 
    base.s.size = 0;
 7a4:	b8 c8 0a 00 00       	mov    $0xac8,%eax
 7a9:	c7 05 cc 0a 00 00 00 	movl   $0x0,0xacc
 7b0:	00 00 00 
