 ...
 3c9:	85 d2                	test   %edx,%edx
{
 ...
 430:	e8 d2 fe ff ff       	call   307 <write>
...
printf(int fd, const char *fmt, ...)
{
 ...
 501:	e8 01 fe ff ff       	call   307 <write>
 ...
 518:	31 ff                	xor    %edi,%edi
  write(fd, &c, 1);
 51a:	e8 e8 fd ff ff       	call   307 <write>
  for(i = 0; fmt[i]; i++){
 ...
 5b3:	57                   	push   %edi
 5b4:	53                   	push   %ebx
 5b5:	e8 4d fd ff ff       	call   307 <write>
        while(*s != 0){
 ...
 607:	e8 fb fc ff ff       	call   307 <write>
        ap++;
 ...
 631:	a1 b4 0a 00 00       	mov    0xab4,%eax
{
 ...
 66d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 66f:	a3 b4 0a 00 00       	mov    %eax,0xab4
}
 674:	5b                   	pop    %ebx
 675:	5e                   	pop    %esi
 676:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 70f:	73 47                	jae    758 <malloc+0x98>
    ...
    if(p == freep)
 711:	39 05 b4 0a 00 00    	cmp    %eax,0xab4
 ...
 736:	e8 f5 fe ff ff       	call   630 <free>
  return freep;
 73b:	8b 15 b4 0a 00 00    	mov    0xab4,%edx
 ...
 764:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 767:	89 15 b4 0a 00 00    	mov    %edx,0xab4
}
 ...
 787:	0a 00 00 
 78a:	c7 05 b8 0a 00 00 b8 	movl   $0xab8,0xab8
 791:	0a 00 00 
    base.s.size = 0;
 794:	b8 b8 0a 00 00       	mov    $0xab8,%eax
 799:	c7 05 bc 0a 00 00 00 	movl   $0x0,0xabc
 7a0:	00 00 00 
