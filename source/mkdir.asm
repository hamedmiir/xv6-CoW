...
main(int argc, char *argv[])
{
  ...
  33:	ff 33                	pushl  (%ebx)
  35:	e8 35 03 00 00       	call   36f <mkdir>
  ...
  exit();
  4b:	e8 b7 02 00 00       	call   307 <exit>
      printf(2, "mkdir: %s failed to create\n", argv[i]);
  50:	50                   	push   %eax
  51:	ff 33                	pushl  (%ebx)
  ...
  6d:	e8 0e 04 00 00       	call   480 <printf>
    exit();
  72:	e8 90 02 00 00       	call   307 <exit>
  77:	66 90                	xchg   %ax,%ax
  79:	66 90                	xchg   %ax,%ax
  7b:	66 90                	xchg   %ax,%ax
  7d:	66 90                	xchg   %ax,%ax
 ...
 651:	a1 e8 0a 00 00       	mov    0xae8,%eax
{
 ...
 68d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 68f:	a3 e8 0a 00 00       	mov    %eax,0xae8
}
 694:	5b                   	pop    %ebx
 695:	5e                   	pop    %esi
 696:	5f                   	pop    %edi
 ...
 6a6:	72 ce                	jb     676 <free+0x26>
{
 ...
 6c7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 6ca:	a3 e8 0a 00 00       	mov    %eax,0xae8
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6e9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6ec:	8b 15 e8 0a 00 00    	mov    0xae8,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 72f:	73 47                	jae    778 <malloc+0x98>
    ...
    if(p == freep)
 731:	39 05 e8 0a 00 00    	cmp    %eax,0xae8
 ...
 756:	e8 f5 fe ff ff       	call   650 <free>
  return freep;
 75b:	8b 15 e8 0a 00 00    	mov    0xae8,%edx
 ...
 784:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 787:	89 15 e8 0a 00 00    	mov    %edx,0xae8
}
 ...
 7a7:	0a 00 00 
 7aa:	c7 05 ec 0a 00 00 ec 	movl   $0xaec,0xaec
 7b1:	0a 00 00 
    base.s.size = 0;
 7b4:	b8 ec 0a 00 00       	mov    $0xaec,%eax
 7b9:	c7 05 f0 0a 00 00 00 	movl   $0x0,0xaf0
 7c0:	00 00 00 
