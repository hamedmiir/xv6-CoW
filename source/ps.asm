...
int main(int argc, char const *argv[])
{
  ...
  11:	e8 61 03 00 00       	call   377 <show_processes_scheduling>
    exit();
  16:	e8 8c 02 00 00       	call   2a7 <exit>
  1b:	66 90                	xchg   %ax,%ax
  1d:	66 90                	xchg   %ax,%ax
  1f:	90                   	nop
 ...
 138:	89 f3                	mov    %esi,%ebx
{
 ...
 150:	50                   	push   %eax
 151:	6a 00                	push   $0x0
 153:	e8 67 01 00 00       	call   2bf <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 1bd:	e8 25 01 00 00       	call   2e7 <open>
  if(fd < 0)
 ...
 1d1:	50                   	push   %eax
 1d2:	e8 28 01 00 00       	call   2ff <fstat>
  close(fd);
 1d7:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 1da:	89 c6                	mov    %eax,%esi
  close(fd);
 1dc:	e8 ee 00 00 00       	call   2cf <close>
  return r;
...
void delay(int numberOfClocks)
{
 ...
 277:	e8 c3 00 00 00       	call   33f <uptime>
 27c:	89 c3                	mov    %eax,%ebx
    int incClock = uptime();
 27e:	e8 bc 00 00 00       	call   33f <uptime>
    while(incClock >= (firstClock + numberOfClocks) )
 283:	03 5d 08             	add    0x8(%ebp),%ebx
 286:	39 d8                	cmp    %ebx,%eax
 288:	7c 0f                	jl     299 <delay+0x29>
 28a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    {
        incClock = uptime();
 290:	e8 aa 00 00 00       	call   33f <uptime>
    while(incClock >= (firstClock + numberOfClocks) )
 295:	39 d8                	cmp    %ebx,%eax
 297:	7d f7                	jge    290 <delay+0x20>
    }
}
 ...
 399:	85 d2                	test   %edx,%edx
{
 ...
 400:	e8 c2 fe ff ff       	call   2c7 <write>
...
printf(int fd, const char *fmt, ...)
{
 ...
 470:	e8 52 fe ff ff       	call   2c7 <write>
 ...
 4d1:	e8 f1 fd ff ff       	call   2c7 <write>
 ...
 4e8:	31 ff                	xor    %edi,%edi
  write(fd, &c, 1);
 4ea:	e8 d8 fd ff ff       	call   2c7 <write>
  for(i = 0; fmt[i]; i++){
 ...
 583:	57                   	push   %edi
 584:	53                   	push   %ebx
 585:	e8 3d fd ff ff       	call   2c7 <write>
        while(*s != 0){
 ...
 5d7:	e8 eb fc ff ff       	call   2c7 <write>
        ap++;
...
malloc(uint nbytes)
{
 ...
 6ee:	56                   	push   %esi
 6ef:	e8 3b fc ff ff       	call   32f <sbrk>
  if(p == (char*)-1)
