...
main(int argc, char *argv[])
{
  ...
  if(open("usertests.ran", 0) >= 0){
      ...
      26:	e8 ec 38 00 00       	call   3917 <open>
    ...
    exit();
      40:	e8 92 38 00 00       	call   38d7 <exit>
  }
  close(open("usertests.ran", O_CREATE));
      ...
      51:	e8 c1 38 00 00       	call   3917 <open>
      56:	89 04 24             	mov    %eax,(%esp)
      59:	e8 a1 38 00 00       	call   38ff <close>
  ...
  exit();
     10d:	e8 c5 37 00 00       	call   38d7 <exit>
...
00000120 <iputtest>:
{
  ...
  if(chdir("iputdir") < 0){
     ...
     151:	e8 f1 37 00 00       	call   3947 <chdir>
  ...
  if(unlink("../iputdir") < 0){
     ...
     169:	e8 b9 37 00 00       	call   3927 <unlink>
  ...
  if(chdir("/") < 0){
     ...
     17d:	e8 c5 37 00 00       	call   3947 <chdir>
  ...
  printf(stdout, "iput test ok\n");
     ...
     191:	ff 35 7c 5e 00 00    	pushl  0x5e7c
    ...
    printf(stdout, "mkdir failed\n");
     ...
     1a8:	ff 35 7c 5e 00 00    	pushl  0x5e7c
     1ae:	e8 9d 38 00 00       	call   3a50 <printf>
    exit();
     1b3:	e8 1f 37 00 00       	call   38d7 <exit>
    printf(stdout, "chdir / failed\n");
     1b8:	50                   	push   %eax
     1b9:	50                   	push   %eax
     1ba:	68 f3 3d 00 00       	push   $0x3df3
     1bf:	ff 35 7c 5e 00 00    	pushl  0x5e7c
     1c5:	e8 86 38 00 00       	call   3a50 <printf>
    exit();
     1ca:	e8 08 37 00 00       	call   38d7 <exit>
    printf(stdout, "unlink ../iputdir failed\n");
     1cf:	52                   	push   %edx
     1d0:	52                   	push   %edx
     1d1:	68 d7 3d 00 00       	push   $0x3dd7
     1d6:	ff 35 7c 5e 00 00    	pushl  0x5e7c
     1dc:	e8 6f 38 00 00       	call   3a50 <printf>
    exit();
     1e1:	e8 f1 36 00 00       	call   38d7 <exit>
    printf(stdout, "chdir iputdir failed\n");
     1e6:	51                   	push   %ecx
     1e7:	51                   	push   %ecx
     1e8:	68 b6 3d 00 00       	push   $0x3db6
     1ed:	ff 35 7c 5e 00 00    	pushl  0x5e7c
     1f3:	e8 58 38 00 00       	call   3a50 <printf>
    exit();
     1f8:	e8 da 36 00 00       	call   38d7 <exit>
...
00000200 <exitiputtest>:
{
  ...
  printf(stdout, "exitiput test\n");
     ...
     20b:	ff 35 7c 5e 00 00    	pushl  0x5e7c
     211:	e8 3a 38 00 00       	call   3a50 <printf>
  pid = fork();
     216:	e8 b4 36 00 00       	call   38cf <fork>
  if(pid < 0){
  ...
  if(pid == 0){
    ...
    if(mkdir("iputdir") < 0){
     ...
     230:	e8 0a 37 00 00       	call   393f <mkdir>
    ...
    if(chdir("iputdir") < 0){
     ...
     248:	e8 fa 36 00 00       	call   3947 <chdir>
    ...
    if(unlink("../iputdir") < 0){
     ...
     25c:	e8 c6 36 00 00       	call   3927 <unlink>
     261:	83 c4 10             	add    $0x10,%esp
     264:	85 c0                	test   %eax,%eax
     266:	78 28                	js     290 <exitiputtest+0x90>
    exit();
     268:	e8 6a 36 00 00       	call   38d7 <exit>
     26d:	8d 76 00             	lea    0x0(%esi),%esi
  wait();
     270:	e8 6a 36 00 00       	call   38df <wait>
  printf(stdout, "exitiput test ok\n");
     275:	83 ec 08             	sub    $0x8,%esp
     278:	68 26 3e 00 00       	push   $0x3e26
     27d:	ff 35 7c 5e 00 00    	pushl  0x5e7c
     ...
     298:	ff 35 7c 5e 00 00    	pushl  0x5e7c
     29e:	e8 ad 37 00 00       	call   3a50 <printf>
      exit();
     2a3:	e8 2f 36 00 00       	call   38d7 <exit>
    printf(stdout, "fork failed\n");
     2a8:	51                   	push   %ecx
     2a9:	51                   	push   %ecx
     2aa:	68 e9 4c 00 00       	push   $0x4ce9
     2af:	ff 35 7c 5e 00 00    	pushl  0x5e7c
     2b5:	e8 96 37 00 00       	call   3a50 <printf>
    exit();
     2ba:	e8 18 36 00 00       	call   38d7 <exit>
      printf(stdout, "child chdir failed\n");
     2bf:	50                   	push   %eax
     2c0:	50                   	push   %eax
     2c1:	68 12 3e 00 00       	push   $0x3e12
     2c6:	ff 35 7c 5e 00 00    	pushl  0x5e7c
     2cc:	e8 7f 37 00 00       	call   3a50 <printf>
      exit();
     2d1:	e8 01 36 00 00       	call   38d7 <exit>
      printf(stdout, "mkdir failed\n");
     2d6:	52                   	push   %edx
     2d7:	52                   	push   %edx
     2d8:	68 a8 3d 00 00       	push   $0x3da8
     2dd:	ff 35 7c 5e 00 00    	pushl  0x5e7c
     2e3:	e8 68 37 00 00       	call   3a50 <printf>
      exit();
     2e8:	e8 ea 35 00 00       	call   38d7 <exit>
...
000002f0 <openiputtest>:
{
  ...
  if(pid == 0){
    ...
    int fd = open("oidir", O_RDWR);
     ...
     336:	e8 dc 35 00 00       	call   3917 <open>
    if(fd >= 0){
  ...
  printf(stdout, "openiput test ok\n");
    ...
    exit();
     3a0:	e8 32 35 00 00       	call   38d7 <exit>
    printf(stdout, "mkdir oidir failed\n");
     3a5:	51                   	push   %ecx
     3a6:	51                   	push   %ecx
     3a7:	68 4d 3e 00 00       	push   $0x3e4d
     3ac:	ff 35 7c 5e 00 00    	pushl  0x5e7c
     3b2:	e8 99 36 00 00       	call   3a50 <printf>
    exit();
     3b7:	e8 1b 35 00 00       	call   38d7 <exit>
    printf(stdout, "fork failed\n");
     3bc:	52                   	push   %edx
     3bd:	52                   	push   %edx
     3be:	68 e9 4c 00 00       	push   $0x4ce9
     3c3:	ff 35 7c 5e 00 00    	pushl  0x5e7c
     3c9:	e8 82 36 00 00       	call   3a50 <printf>
    exit();
     3ce:	e8 04 35 00 00       	call   38d7 <exit>
    printf(stdout, "unlink failed\n");
     3d3:	50                   	push   %eax
     3d4:	50                   	push   %eax
     3d5:	68 61 3e 00 00       	push   $0x3e61
     3da:	ff 35 7c 5e 00 00    	pushl  0x5e7c
     3e0:	e8 6b 36 00 00       	call   3a50 <printf>
    exit();
     3e5:	e8 ed 34 00 00       	call   38d7 <exit>
...
000003f0 <opentest>:
{
  ...
  printf(stdout, "open test\n");
     ...
     3fb:	ff 35 7c 5e 00 00    	pushl  0x5e7c
  ...
  fd = open("echo", 0);
     ...
     40f:	e8 03 35 00 00       	call   3917 <open>
  if(fd < 0){
  ...
  close(fd);
     ...
     41e:	50                   	push   %eax
     41f:	e8 db 34 00 00       	call   38ff <close>
  fd = open("doesnotexist", 0);
     424:	5a                   	pop    %edx
     425:	59                   	pop    %ecx
     426:	6a 00                	push   $0x0
     428:	68 a5 3e 00 00       	push   $0x3ea5
     42d:	e8 e5 34 00 00       	call   3917 <open>
  if(fd >= 0){
  ...
  printf(stdout, "open test ok\n");
     ...
     441:	ff 35 7c 5e 00 00    	pushl  0x5e7c
    ...
    printf(stdout, "open echo failed!\n");
     ...
     458:	ff 35 7c 5e 00 00    	pushl  0x5e7c
     45e:	e8 ed 35 00 00       	call   3a50 <printf>
    exit();
     463:	e8 6f 34 00 00       	call   38d7 <exit>
    printf(stdout, "open doesnotexist succeeded!\n");
     468:	50                   	push   %eax
     469:	50                   	push   %eax
     46a:	68 b2 3e 00 00       	push   $0x3eb2
     46f:	ff 35 7c 5e 00 00    	pushl  0x5e7c
     475:	e8 d6 35 00 00       	call   3a50 <printf>
    exit();
     47a:	e8 58 34 00 00       	call   38d7 <exit>
     47f:	90                   	nop
...
00000480 <writetest>:
{
  ...
  printf(stdout, "small file test\n");
     ...
     48d:	ff 35 7c 5e 00 00    	pushl  0x5e7c
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     4a4:	e8 6e 34 00 00       	call   3917 <open>
  if(fd >= 0){
  ...
  for(i = 0; i < 100; i++){
    ...
    printf(stdout, "creat small succeeded; ok\n");
     ...
     4c0:	ff 35 7c 5e 00 00    	pushl  0x5e7c
    ...
    if(write(fd, "aaaaaaaaaa", 10) != 10){
     ...
     4da:	56                   	push   %esi
     4db:	e8 17 34 00 00       	call   38f7 <write>
    ...
    if(write(fd, "bbbbbbbbbb", 10) != 10){
     ...
     4f6:	56                   	push   %esi
     4f7:	e8 fb 33 00 00       	call   38f7 <write>
  ...
  printf(stdout, "writes ok\n");
     ...
     518:	ff 35 7c 5e 00 00    	pushl  0x5e7c
     51e:	e8 2d 35 00 00       	call   3a50 <printf>
  close(fd);
     523:	89 34 24             	mov    %esi,(%esp)
     526:	e8 d4 33 00 00       	call   38ff <close>
  fd = open("small", O_RDONLY);
     52b:	5b                   	pop    %ebx
     52c:	5e                   	pop    %esi
     52d:	6a 00                	push   $0x0
     52f:	68 ef 3e 00 00       	push   $0x3eef
     534:	e8 de 33 00 00       	call   3917 <open>
  if(fd >= 0){
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open small succeeded ok\n");
     ...
     54e:	ff 35 7c 5e 00 00    	pushl  0x5e7c
     554:	e8 f7 34 00 00       	call   3a50 <printf>
  i = read(fd, buf, 2000);
     559:	83 c4 0c             	add    $0xc,%esp
     55c:	68 d0 07 00 00       	push   $0x7d0
     561:	68 60 86 00 00       	push   $0x8660
     566:	53                   	push   %ebx
     567:	e8 83 33 00 00       	call   38ef <read>
  if(i == 2000){
    ...
    printf(stdout, "read succeeded ok\n");
     ...
     582:	ff 35 7c 5e 00 00    	pushl  0x5e7c
     588:	e8 c3 34 00 00       	call   3a50 <printf>
  close(fd);
     58d:	89 1c 24             	mov    %ebx,(%esp)
     590:	e8 6a 33 00 00       	call   38ff <close>
  if(unlink("small") < 0){
     595:	c7 04 24 ef 3e 00 00 	movl   $0x3eef,(%esp)
     59c:	e8 86 33 00 00       	call   3927 <unlink>
  ...
  printf(stdout, "small file test ok\n");
     ...
     5b0:	ff 35 7c 5e 00 00    	pushl  0x5e7c
...
00000660 <writetest1>:
{
  ...
  printf(stdout, "big files test\n");
     ...
     66d:	ff 35 7c 5e 00 00    	pushl  0x5e7c
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     684:	e8 8e 32 00 00       	call   3917 <open>
  if(fd < 0){
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    if(write(fd, buf, 512) != 512){
     ...
     6b3:	56                   	push   %esi
     6b4:	e8 3e 32 00 00       	call   38f7 <write>
  ...
  close(fd);
     ...
     6d5:	56                   	push   %esi
     6d6:	e8 24 32 00 00       	call   38ff <close>
  fd = open("big", O_RDONLY);
     6db:	5b                   	pop    %ebx
     6dc:	5e                   	pop    %esi
     6dd:	6a 00                	push   $0x0
     6df:	68 37 40 00 00       	push   $0x4037
     6e4:	e8 2e 32 00 00       	call   3917 <open>
  if(fd < 0){
  ...
  n = 0;
    ...
    i = read(fd, buf, 512);
     ...
     71f:	68 60 86 00 00       	push   $0x8660
     724:	56                   	push   %esi
     725:	e8 c5 31 00 00       	call   38ef <read>
    if(i == 0){
  ...
  close(fd);
     ...
     740:	56                   	push   %esi
     741:	e8 b9 31 00 00       	call   38ff <close>
  if(unlink("big") < 0){
     746:	c7 04 24 37 40 00 00 	movl   $0x4037,(%esp)
     74d:	e8 d5 31 00 00       	call   3927 <unlink>
  ...
  printf(stdout, "big files ok\n");
     ...
     765:	ff 35 7c 5e 00 00    	pushl  0x5e7c
     ...
     834:	bb 30 00 00 00       	mov    $0x30,%ebx
{
  ...
  printf(stdout, "many creates, followed by unlink test\n");
     ...
     841:	ff 35 7c 5e 00 00    	pushl  0x5e7c
     847:	e8 04 32 00 00       	call   3a50 <printf>
  name[0] = 'a';
     84c:	c6 05 60 a6 00 00 61 	movb   $0x61,0xa660
  name[2] = '\0';
     853:	c6 05 62 a6 00 00 00 	movb   $0x0,0xa662
     85a:	83 c4 10             	add    $0x10,%esp
     85d:	8d 76 00             	lea    0x0(%esi),%esi
    fd = open(name, O_CREATE|O_RDWR);
     860:	83 ec 08             	sub    $0x8,%esp
    name[1] = '0' + i;
     863:	88 1d 61 a6 00 00    	mov    %bl,0xa661
     869:	83 c3 01             	add    $0x1,%ebx
    fd = open(name, O_CREATE|O_RDWR);
     86c:	68 02 02 00 00       	push   $0x202
     871:	68 60 a6 00 00       	push   $0xa660
     876:	e8 9c 30 00 00       	call   3917 <open>
    close(fd);
     87b:	89 04 24             	mov    %eax,(%esp)
     87e:	e8 7c 30 00 00       	call   38ff <close>
  for(i = 0; i < 52; i++){
     883:	83 c4 10             	add    $0x10,%esp
     886:	80 fb 64             	cmp    $0x64,%bl
     889:	75 d5                	jne    860 <createtest+0x30>
  name[0] = 'a';
     88b:	c6 05 60 a6 00 00 61 	movb   $0x61,0xa660
  name[2] = '\0';
     892:	c6 05 62 a6 00 00 00 	movb   $0x0,0xa662
     899:	bb 30 00 00 00       	mov    $0x30,%ebx
     89e:	66 90                	xchg   %ax,%ax
    unlink(name);
     8a0:	83 ec 0c             	sub    $0xc,%esp
    name[1] = '0' + i;
     8a3:	88 1d 61 a6 00 00    	mov    %bl,0xa661
     8a9:	83 c3 01             	add    $0x1,%ebx
    unlink(name);
     8ac:	68 60 a6 00 00       	push   $0xa660
     8b1:	e8 71 30 00 00       	call   3927 <unlink>
  for(i = 0; i < 52; i++){
  ...
  printf(stdout, "many creates, followed by unlink; ok\n");
     ...
     8c6:	ff 35 7c 5e 00 00    	pushl  0x5e7c
...
000008e0 <dirtest>:
{
  ...
  if(chdir("dir0") < 0){
     ...
     911:	e8 31 30 00 00       	call   3947 <chdir>
  ...
  if(chdir("..") < 0){
     ...
     929:	e8 19 30 00 00       	call   3947 <chdir>
  ...
  if(unlink("dir0") < 0){
     ...
     93d:	e8 e5 2f 00 00       	call   3927 <unlink>
  ...
  printf(stdout, "mkdir test ok\n");
     ...
     951:	ff 35 7c 5e 00 00    	pushl  0x5e7c
    ...
    printf(stdout, "mkdir failed\n");
     ...
     968:	ff 35 7c 5e 00 00    	pushl  0x5e7c
     96e:	e8 dd 30 00 00       	call   3a50 <printf>
    exit();
     973:	e8 5f 2f 00 00       	call   38d7 <exit>
    printf(stdout, "unlink dir0 failed\n");
     978:	50                   	push   %eax
     979:	50                   	push   %eax
     97a:	68 a1 40 00 00       	push   $0x40a1
     97f:	ff 35 7c 5e 00 00    	pushl  0x5e7c
     985:	e8 c6 30 00 00       	call   3a50 <printf>
    exit();
     98a:	e8 48 2f 00 00       	call   38d7 <exit>
    printf(stdout, "chdir .. failed\n");
     98f:	52                   	push   %edx
     990:	52                   	push   %edx
     991:	68 90 40 00 00       	push   $0x4090
     996:	ff 35 7c 5e 00 00    	pushl  0x5e7c
     99c:	e8 af 30 00 00       	call   3a50 <printf>
    exit();
     9a1:	e8 31 2f 00 00       	call   38d7 <exit>
    printf(stdout, "chdir dir0 failed\n");
     9a6:	51                   	push   %ecx
     9a7:	51                   	push   %ecx
     9a8:	68 7d 40 00 00       	push   $0x407d
     9ad:	ff 35 7c 5e 00 00    	pushl  0x5e7c
     9b3:	e8 98 30 00 00       	call   3a50 <printf>
    exit();
     9b8:	e8 1a 2f 00 00       	call   38d7 <exit>
...
000009c0 <exectest>:
{
  ...
  printf(stdout, "exec test\n");
     ...
     9cb:	ff 35 7c 5e 00 00    	pushl  0x5e7c
     9d1:	e8 7a 30 00 00       	call   3a50 <printf>
  if(exec("echo", echoargv) < 0){
     9d6:	5a                   	pop    %edx
     9d7:	59                   	pop    %ecx
     9d8:	68 80 5e 00 00       	push   $0x5e80
     9dd:	68 8d 3e 00 00       	push   $0x3e8d
     9e2:	e8 28 2f 00 00       	call   390f <exec>
    ...
    printf(stdout, "exec echo failed\n");
     ...
     9f7:	ff 35 7c 5e 00 00    	pushl  0x5e7c
     9fd:	e8 4e 30 00 00       	call   3a50 <printf>
    exit();
     a02:	e8 d0 2e 00 00       	call   38d7 <exit>
     ...
     a16:	8d 45 e0             	lea    -0x20(%ebp),%eax
{
  ...
  if(pid == 0){
    ...
    close(fds[1]);
     a4e:	e8 ac 2e 00 00       	call   38ff <close>
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     a60:	57                   	push   %edi
     a61:	68 60 86 00 00       	push   $0x8660
     a66:	ff 75 e0             	pushl  -0x20(%ebp)
     a69:	e8 81 2e 00 00       	call   38ef <read>
     ...
     a7e:	f7 d9                	neg    %ecx
     a80:	38 9c 0b 60 86 00 00 	cmp    %bl,0x8660(%ebx,%ecx,1)
    ...
    close(fds[0]);
     ...
     ace:	e8 2c 2e 00 00       	call   38ff <close>
     ...
     ade:	66 90                	xchg   %ax,%ax
        buf[i] = seq++;
     ae0:	88 84 03 60 86 00 00 	mov    %al,0x8660(%ebx,%eax,1)
     ...
     af6:	68 60 86 00 00       	push   $0x8660
     afb:	ff 75 e4             	pushl  -0x1c(%ebp)
     afe:	e8 f4 2d 00 00       	call   38f7 <write>
    ...
    exit();
     b1f:	e8 b3 2d 00 00       	call   38d7 <exit>
    if(total != 5 * 1033){
    ...
    close(fds[0]);
     ...
     b33:	e8 c7 2d 00 00       	call   38ff <close>
    wait();
     b38:	e8 a2 2d 00 00       	call   38df <wait>
  printf(1, "pipe1 ok\n");
     b3d:	5a                   	pop    %edx
     b3e:	59                   	pop    %ecx
     ...
     b61:	e8 ea 2e 00 00       	call   3a50 <printf>
      exit();
     b66:	e8 6c 2d 00 00       	call   38d7 <exit>
    ...
    exit();
     b79:	e8 59 2d 00 00       	call   38d7 <exit>
    ...
    exit();
     b8c:	e8 46 2d 00 00       	call   38d7 <exit>
     ...
     b9a:	e8 b1 2e 00 00       	call   3a50 <printf>
        exit();
     b9f:	e8 33 2d 00 00       	call   38d7 <exit>
...
00000bb0 <preempt>:
{
  ...
  pid1 = fork();
     bc5:	e8 05 2d 00 00       	call   38cf <fork>
  if(pid1 == 0)
  ...
  pid2 = fork();
     bd5:	e8 f5 2c 00 00       	call   38cf <fork>
  if(pid2 == 0)
  ...
  pipe(pfds);
     ...
     be8:	50                   	push   %eax
     be9:	e8 f9 2c 00 00       	call   38e7 <pipe>
  pid3 = fork();
     bee:	e8 dc 2c 00 00       	call   38cf <fork>
  if(pid3 == 0){
  ...
  close(pfds[0]);
     ...
     c89:	e8 71 2c 00 00       	call   38ff <close>
  printf(1, "kill... ");
     c8e:	58                   	pop    %eax
     c8f:	5a                   	pop    %edx
  ...
  kill(pid1);
     ...
     c9f:	e8 63 2c 00 00       	call   3907 <kill>
  kill(pid2);
     ca4:	89 34 24             	mov    %esi,(%esp)
     ca7:	e8 5b 2c 00 00       	call   3907 <kill>
  kill(pid3);
     cac:	89 1c 24             	mov    %ebx,(%esp)
     caf:	e8 53 2c 00 00       	call   3907 <kill>
  printf(1, "wait... ");
     cb4:	59                   	pop    %ecx
     cb5:	5b                   	pop    %ebx
  ...
  wait();
     cc2:	e8 18 2c 00 00       	call   38df <wait>
  wait();
     cc7:	e8 13 2c 00 00       	call   38df <wait>
  wait();
     ccc:	e8 0e 2c 00 00       	call   38df <wait>
  printf(1, "preempt ok\n");
     cd1:	5e                   	pop    %esi
     cd2:	5f                   	pop    %edi
...
00000cf0 <exitwait>:
{
    ...
    if(pid){
     d00:	74 6f                	je     d71 <exitwait+0x81>
      if(wait() != pid){
     d02:	e8 d8 2b 00 00       	call   38df <wait>
  ...
  for(i = 0; i < 100; i++){
    ...
    pid = fork();
     d10:	e8 ba 2b 00 00       	call   38cf <fork>
    if(pid < 0){
  ...
  printf(1, "exitwait ok\n");
     ...
     d70:	c3                   	ret    
      exit();
     d71:	e8 61 2b 00 00       	call   38d7 <exit>
...
00000d80 <mem>:
{
  ...
  ppid = getpid();
     d97:	e8 bb 2b 00 00       	call   3957 <getpid>
     d9c:	89 c6                	mov    %eax,%esi
  if((pid = fork()) == 0){
     d9e:	e8 2c 2b 00 00       	call   38cf <fork>
    ...
    exit();
     e0f:	e8 c3 2a 00 00       	call   38d7 <exit>
     ...
     e2a:	e8 d8 2a 00 00       	call   3907 <kill>
      exit();
     e2f:	e8 a3 2a 00 00       	call   38d7 <exit>
     ...
     e3e:	5d                   	pop    %ebp
    wait();
     e3f:	e9 9b 2a 00 00       	jmp    38df <wait>
...
00000e50 <sharedfd>:
{
  ...
  unlink("sharedfd");
     ...
     e6c:	e8 b6 2a 00 00       	call   3927 <unlink>
  fd = open("sharedfd", O_CREATE|O_RDWR);
     e71:	59                   	pop    %ecx
     e72:	5b                   	pop    %ebx
     e73:	68 02 02 00 00       	push   $0x202
     e78:	68 e3 41 00 00       	push   $0x41e3
     e7d:	e8 95 2a 00 00       	call   3917 <open>
  if(fd < 0){
  ...
  pid = fork();
     e94:	e8 36 2a 00 00       	call   38cf <fork>
  memset(buf, pid==0?'c':'p', sizeof(buf));
  ...
  for(i = 0; i < 1000; i++){
    ...
    if(write(fd, buf, sizeof(buf)) != sizeof(buf)){
     ...
     ecd:	50                   	push   %eax
     ece:	56                   	push   %esi
     ecf:	e8 23 2a 00 00       	call   38f7 <write>
  ...
  if(pid == 0)
    ...
    wait();
     ef6:	e8 e4 29 00 00       	call   38df <wait>
  close(fd);
  ...
  close(fd);
     ...
     f06:	e8 f4 29 00 00       	call   38ff <close>
  fd = open("sharedfd", 0);
     f0b:	58                   	pop    %eax
     f0c:	5a                   	pop    %edx
     f0d:	6a 00                	push   $0x0
     f0f:	68 e3 41 00 00       	push   $0x41e3
     f14:	e8 fe 29 00 00       	call   3917 <open>
  if(fd < 0){
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
     ...
     f3c:	e8 ae 29 00 00       	call   38ef <read>
  ...
  close(fd);
     ...
     f7c:	e8 7e 29 00 00       	call   38ff <close>
  unlink("sharedfd");
     f81:	c7 04 24 e3 41 00 00 	movl   $0x41e3,(%esp)
     f88:	e8 9a 29 00 00       	call   3927 <unlink>
  if(nc == 10000 && np == 10000){
    ...
    return;
     ...
     ff3:	c3                   	ret    
    exit();
     ff4:	e8 de 28 00 00       	call   38d7 <exit>
    ...
    exit();
    1007:	e8 cb 28 00 00       	call   38d7 <exit>
    ...
    101b:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "fourfiles test\n");
    ...
    104e:	56                   	push   %esi
    104f:	e8 d3 28 00 00       	call   3927 <unlink>
    pid = fork();
    1054:	e8 76 28 00 00       	call   38cf <fork>
    if(pid < 0){
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    wait();
    1078:	e8 62 28 00 00       	call   38df <wait>
  for(i = 0; i < 2; i++){
    107d:	31 ff                	xor    %edi,%edi
    wait();
    107f:	e8 5b 28 00 00       	call   38df <wait>
    1084:	e8 56 28 00 00       	call   38df <wait>
    1089:	e8 51 28 00 00       	call   38df <wait>
    ...
    109f:	e8 73 28 00 00       	call   3917 <open>
    while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    10b8:	68 60 86 00 00       	push   $0x8660
    10bd:	ff 75 d4             	pushl  -0x2c(%ebp)
    10c0:	e8 2a 28 00 00       	call   38ef <read>
    ...
    10ce:	66 90                	xchg   %ax,%ax
        if(buf[j] != '0'+i){
    10d0:	0f be b2 60 86 00 00 	movsbl 0x8660(%edx),%esi
    ...
    10f8:	e8 02 28 00 00       	call   38ff <close>
    if(total != 12*500){
    ...
    1112:	e8 10 28 00 00       	call   3927 <unlink>
  for(i = 0; i < 2; i++){
  ...
  printf(1, "fourfiles ok\n");
    ...
    1151:	56                   	push   %esi
    1152:	e8 c0 27 00 00       	call   3917 <open>
      if(fd < 0){
    ...
    1171:	68 60 86 00 00       	push   $0x8660
    ...
    1186:	68 60 86 00 00       	push   $0x8660
    118b:	56                   	push   %esi
    118c:	e8 66 27 00 00       	call   38f7 <write>
    ...
    119e:	75 de                	jne    117e <fourfiles+0x16e>
      exit();
    11a0:	e8 32 27 00 00       	call   38d7 <exit>
          printf(1, "wrong char\n");
    ...
    11af:	e8 9c 28 00 00       	call   3a50 <printf>
          exit();
    11b4:	e8 1e 27 00 00       	call   38d7 <exit>
    ...
    11c2:	e8 89 28 00 00       	call   3a50 <printf>
        exit();
    11c7:	e8 0b 27 00 00       	call   38d7 <exit>
      printf(1, "fork failed\n");
    11cc:	53                   	push   %ebx
    11cd:	53                   	push   %ebx
    ...
    11d5:	e8 76 28 00 00       	call   3a50 <printf>
      exit();
    11da:	e8 f8 26 00 00       	call   38d7 <exit>
    ...
    11e8:	e8 63 28 00 00       	call   3a50 <printf>
      exit();
    11ed:	e8 e5 26 00 00       	call   38d7 <exit>
    ...
    11fb:	e8 50 28 00 00       	call   3a50 <printf>
          exit();
    1200:	e8 d2 26 00 00       	call   38d7 <exit>
    ...
    1216:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "createdelete test\n");
    ...
    pid = fork();
    122a:	e8 a0 26 00 00       	call   38cf <fork>
    if(pid < 0){
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    wait();
    124d:	e8 8d 26 00 00       	call   38df <wait>
    1252:	e8 88 26 00 00       	call   38df <wait>
    1257:	e8 83 26 00 00       	call   38df <wait>
    125c:	e8 7e 26 00 00       	call   38df <wait>
  name[0] = name[1] = name[2] = 0;
    ...
    1296:	88 45 c9             	mov    %al,-0x37(%ebp)
      fd = open(name, 0);
    1299:	e8 79 26 00 00       	call   3917 <open>
      if((i == 0 || i >= N/2) && fd < 0){
    ...
    12bf:	50                   	push   %eax
    12c0:	e8 3a 26 00 00       	call   38ff <close>
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    12f8:	88 45 c9             	mov    %al,-0x37(%ebp)
      unlink(name);
    12fb:	e8 27 26 00 00       	call   3927 <unlink>
    for(pi = 0; pi < 4; pi++){
  ...
  printf(1, "createdelete ok\n");
    ...
    1374:	88 45 c9             	mov    %al,-0x37(%ebp)
        fd = open(name, O_CREATE | O_RDWR);
    1377:	e8 9b 25 00 00       	call   3917 <open>
        if(fd < 0){
    ...
    1386:	50                   	push   %eax
    1387:	e8 73 25 00 00       	call   38ff <close>
        if(i > 0 && (i % 2 ) == 0){
    ...
    13a3:	88 45 c9             	mov    %al,-0x37(%ebp)
          if(unlink(name) < 0){
    13a6:	e8 7c 25 00 00       	call   3927 <unlink>
    ...
    13bb:	e8 90 26 00 00       	call   3a50 <printf>
            exit();
    13c0:	e8 12 25 00 00       	call   38d7 <exit>
    13c5:	8d 76 00             	lea    0x0(%esi),%esi
      exit();
    13c8:	e8 0a 25 00 00       	call   38d7 <exit>
    ...
    13d8:	e8 73 26 00 00       	call   3a50 <printf>
        exit();
    13dd:	e8 f5 24 00 00       	call   38d7 <exit>
          printf(1, "create failed\n");
    13e2:	51                   	push   %ecx
    13e3:	51                   	push   %ecx
    ...
    13eb:	e8 60 26 00 00       	call   3a50 <printf>
          exit();
    13f0:	e8 e2 24 00 00       	call   38d7 <exit>
      printf(1, "fork failed\n");
    13f5:	53                   	push   %ebx
    13f6:	53                   	push   %ebx
    ...
    13fe:	e8 4d 26 00 00       	call   3a50 <printf>
      exit();
    1403:	e8 cf 24 00 00       	call   38d7 <exit>
      } else if((i >= 1 && i < N/2) && fd >= 0){
    ...
    1419:	e8 32 26 00 00       	call   3a50 <printf>
        exit();
    141e:	e8 b4 24 00 00       	call   38d7 <exit>
...
00001430 <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
    ...
    1450:	e8 c2 24 00 00       	call   3917 <open>
  if(fd < 0){
  ...
  write(fd, "hello", 5);
    ...
    146c:	50                   	push   %eax
    146d:	e8 85 24 00 00       	call   38f7 <write>
  close(fd);
    1472:	89 1c 24             	mov    %ebx,(%esp)
    1475:	e8 85 24 00 00       	call   38ff <close>
  fd = open("unlinkread", O_RDWR);
    147a:	58                   	pop    %eax
    147b:	5a                   	pop    %edx
    147c:	6a 02                	push   $0x2
    147e:	68 95 42 00 00       	push   $0x4295
    1483:	e8 8f 24 00 00       	call   3917 <open>
  if(fd < 0){
  ...
  if(unlink("unlinkread") != 0){
    ...
    149d:	e8 85 24 00 00       	call   3927 <unlink>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
    ...
    14ba:	e8 58 24 00 00       	call   3917 <open>
  write(fd1, "yyy", 3);
  ...
  close(fd);
    ...
    151c:	53                   	push   %ebx
    151d:	e8 dd 23 00 00       	call   38ff <close>
  unlink("unlinkread");
    1522:	c7 04 24 95 42 00 00 	movl   $0x4295,(%esp)
    1529:	e8 f9 23 00 00       	call   3927 <unlink>
  printf(1, "unlinkread ok\n");
    ...
    exit();
    1554:	e8 7e 23 00 00       	call   38d7 <exit>
    ...
    exit();
    1567:	e8 6b 23 00 00       	call   38d7 <exit>
    ...
    exit();
    157a:	e8 58 23 00 00       	call   38d7 <exit>
    ...
    exit();
    158d:	e8 45 23 00 00       	call   38d7 <exit>
    ...
    exit();
    15a0:	e8 32 23 00 00       	call   38d7 <exit>
    ...
    exit();
    15b3:	e8 1f 23 00 00       	call   38d7 <exit>
    15b8:	90                   	nop
...
000015c0 <linktest>:
{
  ...
  if(write(fd, "hello", 5) != 5){
    ...
    1613:	50                   	push   %eax
    1614:	e8 de 22 00 00       	call   38f7 <write>
  ...
  close(fd);
    ...
    1628:	53                   	push   %ebx
    1629:	e8 d1 22 00 00       	call   38ff <close>
  if(link("lf1", "lf2") < 0){
    162e:	5b                   	pop    %ebx
    162f:	58                   	pop    %eax
    1630:	68 5a 43 00 00       	push   $0x435a
    1635:	68 56 43 00 00       	push   $0x4356
    163a:	e8 f8 22 00 00       	call   3937 <link>
  ...
  unlink("lf1");
    ...
    1652:	e8 d0 22 00 00       	call   3927 <unlink>
  if(open("lf1", 0) >= 0){
    1657:	58                   	pop    %eax
    1658:	5a                   	pop    %edx
    1659:	6a 00                	push   $0x0
    165b:	68 56 43 00 00       	push   $0x4356
    1660:	e8 b2 22 00 00       	call   3917 <open>
  ...
  fd = open("lf2", 0);
    ...
    167a:	e8 98 22 00 00       	call   3917 <open>
  if(fd < 0){
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    1694:	68 60 86 00 00       	push   $0x8660
    1699:	50                   	push   %eax
    169a:	e8 50 22 00 00       	call   38ef <read>
  ...
  close(fd);
    ...
    16ae:	53                   	push   %ebx
    16af:	e8 4b 22 00 00       	call   38ff <close>
  if(link("lf2", "lf2") >= 0){
    16b4:	58                   	pop    %eax
    16b5:	5a                   	pop    %edx
    16b6:	68 5a 43 00 00       	push   $0x435a
    16bb:	68 5a 43 00 00       	push   $0x435a
    16c0:	e8 72 22 00 00       	call   3937 <link>
  ...
  unlink("lf2");
    ...
    16d8:	e8 4a 22 00 00       	call   3927 <unlink>
  if(link("lf2", "lf1") >= 0){
    16dd:	59                   	pop    %ecx
    16de:	5b                   	pop    %ebx
    16df:	68 56 43 00 00       	push   $0x4356
    16e4:	68 5a 43 00 00       	push   $0x435a
    16e9:	e8 49 22 00 00       	call   3937 <link>
  ...
  if(link(".", "lf1") >= 0){
    ...
    1702:	e8 30 22 00 00       	call   3937 <link>
  ...
  printf(1, "linktest ok\n");
    ...
    exit();
    1733:	e8 9f 21 00 00       	call   38d7 <exit>
    ...
    exit();
    1746:	e8 8c 21 00 00       	call   38d7 <exit>
    ...
    exit();
    1759:	e8 79 21 00 00       	call   38d7 <exit>
    ...
    exit();
    176c:	e8 66 21 00 00       	call   38d7 <exit>
    ...
    exit();
    177f:	e8 53 21 00 00       	call   38d7 <exit>
    ...
    exit();
    1792:	e8 40 21 00 00       	call   38d7 <exit>
    ...
    exit();
    17a5:	e8 2d 21 00 00       	call   38d7 <exit>
    ...
    exit();
    17b8:	e8 1a 21 00 00       	call   38d7 <exit>
    ...
    exit();
    17cb:	e8 07 21 00 00       	call   38d7 <exit>
    ...
    17db:	bf ab aa aa aa       	mov    $0xaaaaaaab,%edi
{
  ...
  file[2] = '\0';
    ...
    181e:	53                   	push   %ebx
    181f:	e8 f3 20 00 00       	call   3917 <open>
      if(fd < 0){
  ...
  for(i = 0; i < 40; i++){
    182e:	83 c6 01             	add    $0x1,%esi
      close(fd);
    1831:	50                   	push   %eax
    1832:	e8 c8 20 00 00       	call   38ff <close>
    1837:	83 c4 10             	add    $0x10,%esp
      wait();
    183a:	e8 a0 20 00 00       	call   38df <wait>
  for(i = 0; i < 40; i++){
    ...
    unlink(file);
    1852:	e8 d0 20 00 00       	call   3927 <unlink>
    pid = fork();
    1857:	e8 73 20 00 00       	call   38cf <fork>
    if(pid && (i % 3) == 1){
    ...
    1881:	53                   	push   %ebx
    1882:	e8 90 20 00 00       	call   3917 <open>
      if(fd < 0){
    ...
    189d:	e8 ae 21 00 00       	call   3a50 <printf>
        exit();
    18a2:	e8 30 20 00 00       	call   38d7 <exit>
    ...
    18b9:	e8 79 20 00 00       	call   3937 <link>
    18be:	83 c4 10             	add    $0x10,%esp
      exit();
    18c1:	e8 11 20 00 00       	call   38d7 <exit>
  ...
  for(i = 0; i < 40; i++){
    ...
    18dc:	e8 56 20 00 00       	call   3937 <link>
    18e1:	83 c4 10             	add    $0x10,%esp
      wait();
    18e4:	e8 f6 1f 00 00       	call   38df <wait>
  for(i = 0; i < 40; i++){
  ...
  fd = open(".", 0);
    ...
    190e:	e8 04 20 00 00       	call   3917 <open>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    1925:	57                   	push   %edi
    1926:	56                   	push   %esi
    1927:	e8 c3 1f 00 00       	call   38ef <read>
  ...
  close(fd);
    ...
    1973:	56                   	push   %esi
    1974:	e8 86 1f 00 00       	call   38ff <close>
  if(n != 40){
  ...
  for(i = 0; i < 40; i++){
    ...
    199c:	53                   	push   %ebx
    199d:	e8 85 1f 00 00       	call   3927 <unlink>
      unlink(file);
    19a2:	89 1c 24             	mov    %ebx,(%esp)
    19a5:	e8 7d 1f 00 00       	call   3927 <unlink>
      unlink(file);
    19aa:	89 1c 24             	mov    %ebx,(%esp)
    19ad:	e8 75 1f 00 00       	call   3927 <unlink>
      unlink(file);
    19b2:	89 1c 24             	mov    %ebx,(%esp)
    19b5:	e8 6d 1f 00 00       	call   3927 <unlink>
  ...
  for(i = 0; i < 40; i++){
    19c5:	83 c6 01             	add    $0x1,%esi
      wait();
    19c8:	e8 12 1f 00 00       	call   38df <wait>
  for(i = 0; i < 40; i++){
    ...
    pid = fork();
    19d8:	e8 f2 1e 00 00       	call   38cf <fork>
    if(pid < 0){
    ...
    1a00:	6a 00                	push   $0x0
    1a02:	53                   	push   %ebx
    1a03:	e8 0f 1f 00 00       	call   3917 <open>
    1a08:	89 04 24             	mov    %eax,(%esp)
    1a0b:	e8 ef 1e 00 00       	call   38ff <close>
      close(open(file, 0));
    1a10:	58                   	pop    %eax
    1a11:	5a                   	pop    %edx
    1a12:	6a 00                	push   $0x0
    1a14:	53                   	push   %ebx
    1a15:	e8 fd 1e 00 00       	call   3917 <open>
    1a1a:	89 04 24             	mov    %eax,(%esp)
    1a1d:	e8 dd 1e 00 00       	call   38ff <close>
      close(open(file, 0));
    1a22:	59                   	pop    %ecx
    1a23:	58                   	pop    %eax
    1a24:	6a 00                	push   $0x0
    1a26:	53                   	push   %ebx
    1a27:	e8 eb 1e 00 00       	call   3917 <open>
    1a2c:	89 04 24             	mov    %eax,(%esp)
    1a2f:	e8 cb 1e 00 00       	call   38ff <close>
      close(open(file, 0));
    1a34:	58                   	pop    %eax
    1a35:	5a                   	pop    %edx
    1a36:	6a 00                	push   $0x0
    1a38:	53                   	push   %ebx
    1a39:	e8 d9 1e 00 00       	call   3917 <open>
    1a3e:	89 04 24             	mov    %eax,(%esp)
    1a41:	e8 b9 1e 00 00       	call   38ff <close>
  ...
  printf(1, "concreate ok\n");
    ...
    1a71:	e8 da 1f 00 00       	call   3a50 <printf>
      exit();
    1a76:	e8 5c 1e 00 00       	call   38d7 <exit>
    ...
    exit();
    1a89:	e8 49 1e 00 00       	call   38d7 <exit>
    ...
    1a9a:	e8 b1 1f 00 00       	call   3a50 <printf>
        exit();
    1a9f:	e8 33 1e 00 00       	call   38d7 <exit>
    ...
    1ab0:	e8 9b 1f 00 00       	call   3a50 <printf>
        exit();
    1ab5:	e8 1d 1e 00 00       	call   38d7 <exit>
      close(fd);
    1aba:	83 ec 0c             	sub    $0xc,%esp
    1abd:	50                   	push   %eax
    1abe:	e8 3c 1e 00 00       	call   38ff <close>
...
00001ad0 <linkunlink>:
{
  ...
  unlink("x");
    ...
    1aec:	e8 36 1e 00 00       	call   3927 <unlink>
  pid = fork();
    1af1:	e8 d9 1d 00 00       	call   38cf <fork>
  if(pid < 0){
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1b2d:	e8 f5 1d 00 00       	call   3927 <unlink>
  ...
  for(i = 0; i < 100; i++){
    ...
    1b62:	e8 b0 1d 00 00       	call   3917 <open>
    1b67:	89 04 24             	mov    %eax,(%esp)
    1b6a:	e8 90 1d 00 00       	call   38ff <close>
  ...
  if(pid)
    ...
    wait();
    1b7e:	e8 5c 1d 00 00       	call   38df <wait>
  printf(1, "linkunlink ok\n");
    ...
    1bad:	e8 85 1d 00 00       	call   3937 <link>
    ...
    exit();
    1bc8:	e8 0a 1d 00 00       	call   38d7 <exit>
    exit();
    1bcd:	e8 05 1d 00 00       	call   38d7 <exit>
...
00001be0 <bigdir>:
{
  ...
  unlink("bd");
    ...
    1bfc:	e8 26 1d 00 00       	call   3927 <unlink>
  fd = open("bd", O_CREATE);
    1c01:	5a                   	pop    %edx
    1c02:	59                   	pop    %ecx
    1c03:	68 00 02 00 00       	push   $0x200
    1c08:	68 a5 44 00 00       	push   $0x44a5
    1c0d:	e8 05 1d 00 00       	call   3917 <open>
  if(fd < 0){
  ...
  close(fd);
    1c25:	50                   	push   %eax
    1c26:	e8 d4 1c 00 00       	call   38ff <close>
    ...
    if(link("bd", name) != 0){
    1c57:	e8 db 1c 00 00       	call   3937 <link>
  ...
  unlink("bd");
    ...
    1c78:	e8 aa 1c 00 00       	call   3927 <unlink>
    ...
    if(unlink(name) != 0){
    1ca2:	e8 80 1c 00 00       	call   3927 <unlink>
  ...
  printf(1, "bigdir ok\n");
    ...
    1cdd:	e8 6e 1d 00 00       	call   3a50 <printf>
      exit();
    1ce2:	e8 f0 1b 00 00       	call   38d7 <exit>
    ...
    1cf1:	e8 5a 1d 00 00       	call   3a50 <printf>
      exit();
    1cf6:	e8 dc 1b 00 00       	call   38d7 <exit>
    ...
    exit();
    1d09:	e8 c9 1b 00 00       	call   38d7 <exit>
...
00001d10 <subdir>:
{
  ...
  unlink("ff");
    ...
    1d2a:	e8 f8 1b 00 00       	call   3927 <unlink>
  if(mkdir("dd") != 0){
    1d2f:	c7 04 24 18 46 00 00 	movl   $0x4618,(%esp)
    1d36:	e8 04 1c 00 00       	call   393f <mkdir>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    1d53:	e8 bf 1b 00 00       	call   3917 <open>
  if(fd < 0){
  ...
  write(fd, "ff", 2);
    ...
    1d6f:	50                   	push   %eax
    1d70:	e8 82 1b 00 00       	call   38f7 <write>
  close(fd);
    1d75:	89 1c 24             	mov    %ebx,(%esp)
    1d78:	e8 82 1b 00 00       	call   38ff <close>
  if(unlink("dd") >= 0){
    1d7d:	c7 04 24 18 46 00 00 	movl   $0x4618,(%esp)
    1d84:	e8 9e 1b 00 00       	call   3927 <unlink>
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    1d9c:	e8 9e 1b 00 00       	call   393f <mkdir>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    1db9:	e8 59 1b 00 00       	call   3917 <open>
  if(fd < 0){
  ...
  write(fd, "FF", 2);
    ...
    1dd5:	50                   	push   %eax
    1dd6:	e8 1c 1b 00 00       	call   38f7 <write>
  close(fd);
    1ddb:	89 1c 24             	mov    %ebx,(%esp)
    1dde:	e8 1c 1b 00 00       	call   38ff <close>
  fd = open("dd/dd/../ff", 0);
    1de3:	58                   	pop    %eax
    1de4:	5a                   	pop    %edx
    1de5:	6a 00                	push   $0x0
    1de7:	68 72 45 00 00       	push   $0x4572
    1dec:	e8 26 1b 00 00       	call   3917 <open>
  if(fd < 0){
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    1e57:	e8 cb 1a 00 00       	call   3927 <unlink>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    1e71:	e8 a1 1a 00 00       	call   3917 <open>
  ...
  if(chdir("dd") != 0){
    ...
    1e89:	e8 b9 1a 00 00       	call   3947 <chdir>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    1ea1:	e8 a1 1a 00 00       	call   3947 <chdir>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    1eb9:	e8 89 1a 00 00       	call   3947 <chdir>
  ...
  if(chdir("./..") != 0){
    ...
    1ed1:	e8 71 1a 00 00       	call   3947 <chdir>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    1eeb:	e8 27 1a 00 00       	call   3917 <open>
  if(fd < 0){
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    1f05:	68 60 86 00 00       	push   $0x8660
    1f0a:	50                   	push   %eax
    1f0b:	e8 df 19 00 00       	call   38ef <read>
  ...
  close(fd);
    ...
    1f1f:	53                   	push   %ebx
    1f20:	e8 da 19 00 00       	call   38ff <close>
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    1f25:	59                   	pop    %ecx
    1f26:	5b                   	pop    %ebx
    1f27:	6a 00                	push   $0x0
    1f29:	68 4e 45 00 00       	push   $0x454e
    1f2e:	e8 e4 19 00 00       	call   3917 <open>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    1f4b:	e8 c7 19 00 00       	call   3917 <open>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    1f68:	e8 aa 19 00 00       	call   3917 <open>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    1f85:	e8 8d 19 00 00       	call   3917 <open>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    1f9f:	e8 73 19 00 00       	call   3917 <open>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    1fb9:	e8 59 19 00 00       	call   3917 <open>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    1fd6:	e8 5c 19 00 00       	call   3937 <link>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    1ff3:	e8 3f 19 00 00       	call   3937 <link>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    2010:	e8 22 19 00 00       	call   3937 <link>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    2028:	e8 12 19 00 00       	call   393f <mkdir>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    2040:	e8 fa 18 00 00       	call   393f <mkdir>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    2058:	e8 e2 18 00 00       	call   393f <mkdir>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    2070:	e8 b2 18 00 00       	call   3927 <unlink>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    2088:	e8 9a 18 00 00       	call   3927 <unlink>
  ...
  if(chdir("dd/ff") == 0){
    ...
    20a0:	e8 a2 18 00 00       	call   3947 <chdir>
  ...
  if(chdir("dd/xx") == 0){
    ...
    20b8:	e8 8a 18 00 00       	call   3947 <chdir>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    20d0:	e8 52 18 00 00       	call   3927 <unlink>
  ...
  if(unlink("dd/ff") != 0){
    ...
    20e8:	e8 3a 18 00 00       	call   3927 <unlink>
  ...
  if(unlink("dd") == 0){
    ...
    2100:	e8 22 18 00 00       	call   3927 <unlink>
  ...
  if(unlink("dd/dd") < 0){
    ...
    2118:	e8 0a 18 00 00       	call   3927 <unlink>
  ...
  if(unlink("dd") < 0){
    ...
    2130:	e8 f2 17 00 00       	call   3927 <unlink>
  ...
  printf(1, "subdir ok\n");
    ...
    exit();
    2165:	e8 6d 17 00 00       	call   38d7 <exit>
    ...
    exit();
    2178:	e8 5a 17 00 00       	call   38d7 <exit>
    ...
    exit();
    218b:	e8 47 17 00 00       	call   38d7 <exit>
    ...
    exit();
    219e:	e8 34 17 00 00       	call   38d7 <exit>
    ...
    exit();
    21b1:	e8 21 17 00 00       	call   38d7 <exit>
    ...
    exit();
    21c4:	e8 0e 17 00 00       	call   38d7 <exit>
    ...
    exit();
    21d7:	e8 fb 16 00 00       	call   38d7 <exit>
    ...
    exit();
    21ea:	e8 e8 16 00 00       	call   38d7 <exit>
    ...
    exit();
    21fd:	e8 d5 16 00 00       	call   38d7 <exit>
    ...
    exit();
    2210:	e8 c2 16 00 00       	call   38d7 <exit>
    ...
    exit();
    2223:	e8 af 16 00 00       	call   38d7 <exit>
    ...
    exit();
    2236:	e8 9c 16 00 00       	call   38d7 <exit>
    ...
    exit();
    2249:	e8 89 16 00 00       	call   38d7 <exit>
    ...
    exit();
    225c:	e8 76 16 00 00       	call   38d7 <exit>
    ...
    exit();
    226f:	e8 63 16 00 00       	call   38d7 <exit>
    ...
    exit();
    2282:	e8 50 16 00 00       	call   38d7 <exit>
    ...
    exit();
    2295:	e8 3d 16 00 00       	call   38d7 <exit>
    ...
    exit();
    22a8:	e8 2a 16 00 00       	call   38d7 <exit>
    printf(1, "open (unlinked) dd/dd/ff succeeded\n");
    22ad:	50                   	push   %eax
    22ae:	50                   	push   %eax
    ...
    exit();
    22bb:	e8 17 16 00 00       	call   38d7 <exit>
    ...
    exit();
    22ce:	e8 04 16 00 00       	call   38d7 <exit>
    ...
    exit();
    22e1:	e8 f1 15 00 00       	call   38d7 <exit>
    ...
    exit();
    22f4:	e8 de 15 00 00       	call   38d7 <exit>
    ...
    exit();
    2307:	e8 cb 15 00 00       	call   38d7 <exit>
    ...
    exit();
    231a:	e8 b8 15 00 00       	call   38d7 <exit>
    ...
    exit();
    232d:	e8 a5 15 00 00       	call   38d7 <exit>
    ...
    exit();
    2340:	e8 92 15 00 00       	call   38d7 <exit>
    ...
    exit();
    2353:	e8 7f 15 00 00       	call   38d7 <exit>
    ...
    exit();
    2366:	e8 6c 15 00 00       	call   38d7 <exit>
    ...
    exit();
    2379:	e8 59 15 00 00       	call   38d7 <exit>
    ...
    exit();
    238c:	e8 46 15 00 00       	call   38d7 <exit>
    ...
    exit();
    239f:	e8 33 15 00 00       	call   38d7 <exit>
    ...
    exit();
    23b2:	e8 20 15 00 00       	call   38d7 <exit>
    ...
    exit();
    23c5:	e8 0d 15 00 00       	call   38d7 <exit>
    ...
    exit();
    23d8:	e8 fa 14 00 00       	call   38d7 <exit>
    ...
    exit();
    23eb:	e8 e7 14 00 00       	call   38d7 <exit>
...
000023f0 <bigwrite>:
{
  ...
  unlink("bigwrite");
    ...
    2410:	e8 12 15 00 00       	call   3927 <unlink>
    ...
    242d:	e8 e5 14 00 00       	call   3917 <open>
    if(fd < 0){
    ...
    243e:	53                   	push   %ebx
    243f:	68 60 86 00 00       	push   $0x8660
    2444:	50                   	push   %eax
    2445:	e8 ad 14 00 00       	call   38f7 <write>
      if(cc != sz){
    ...
    2454:	53                   	push   %ebx
    2455:	68 60 86 00 00       	push   $0x8660
    245a:	56                   	push   %esi
    245b:	e8 97 14 00 00       	call   38f7 <write>
      if(cc != sz){
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    close(fd);
    2470:	56                   	push   %esi
    2471:	e8 89 14 00 00       	call   38ff <close>
    unlink("bigwrite");
    2476:	c7 04 24 14 48 00 00 	movl   $0x4814,(%esp)
    247d:	e8 a5 14 00 00       	call   3927 <unlink>
  for(sz = 499; sz < 12*512; sz += 471){
  ...
  printf(1, "bigwrite ok\n");
    ...
    24af:	e8 9c 15 00 00       	call   3a50 <printf>
        exit();
    24b4:	e8 1e 14 00 00       	call   38d7 <exit>
    ...
    24c3:	e8 88 15 00 00       	call   3a50 <printf>
      exit();
    24c8:	e8 0a 14 00 00       	call   38d7 <exit>
...
000024d0 <bigfile>:
{
  ...
  unlink("bigfile");
    ...
    24ec:	e8 36 14 00 00       	call   3927 <unlink>
  fd = open("bigfile", O_CREATE | O_RDWR);
    24f1:	58                   	pop    %eax
    24f2:	5a                   	pop    %edx
    24f3:	68 02 02 00 00       	push   $0x202
    24f8:	68 70 48 00 00       	push   $0x4870
    24fd:	e8 15 14 00 00       	call   3917 <open>
  if(fd < 0){
  ...
  for(i = 0; i < 20; i++){
    ...
    2520:	53                   	push   %ebx
    2521:	68 60 86 00 00       	push   $0x8660
    2526:	e8 d5 11 00 00       	call   3700 <memset>
    if(write(fd, buf, 600) != 600){
    252b:	83 c4 0c             	add    $0xc,%esp
    252e:	68 58 02 00 00       	push   $0x258
    2533:	68 60 86 00 00       	push   $0x8660
    2538:	56                   	push   %esi
    2539:	e8 b9 13 00 00       	call   38f7 <write>
  ...
  close(fd);
    ...
    2557:	56                   	push   %esi
    2558:	e8 a2 13 00 00       	call   38ff <close>
  fd = open("bigfile", 0);
    255d:	5e                   	pop    %esi
    255e:	5f                   	pop    %edi
    255f:	6a 00                	push   $0x0
    2561:	68 70 48 00 00       	push   $0x4870
    2566:	e8 ac 13 00 00       	call   3917 <open>
  if(fd < 0){
  ...
  for(i = 0; ; i++){
    ...
    258b:	0f be 05 60 86 00 00 	movsbl 0x8660,%eax
  ...
  for(i = 0; ; i++){
    ...
    25bb:	56                   	push   %esi
    25bc:	e8 2e 13 00 00       	call   38ef <read>
    if(cc < 0){
  ...
  close(fd);
    ...
    25cd:	56                   	push   %esi
    25ce:	e8 2c 13 00 00       	call   38ff <close>
  if(total != 20*600){
  ...
  unlink("bigfile");
    ...
    25ea:	e8 38 13 00 00       	call   3927 <unlink>
  printf(1, "bigfile test ok\n");
    ...
    2612:	e8 39 14 00 00       	call   3a50 <printf>
      exit();
    2617:	e8 bb 12 00 00       	call   38d7 <exit>
    ...
    2626:	e8 25 14 00 00       	call   3a50 <printf>
      exit();
    262b:	e8 a7 12 00 00       	call   38d7 <exit>
    ...
    263a:	e8 11 14 00 00       	call   3a50 <printf>
      exit();
    263f:	e8 93 12 00 00       	call   38d7 <exit>
    ...
    264e:	e8 fd 13 00 00       	call   3a50 <printf>
      exit();
    2653:	e8 7f 12 00 00       	call   38d7 <exit>
    ...
    exit();
    2666:	e8 6c 12 00 00       	call   38d7 <exit>
    ...
    exit();
    2679:	e8 59 12 00 00       	call   38d7 <exit>
    ...
    exit();
    268c:	e8 46 12 00 00       	call   38d7 <exit>
...
000026a0 <fourteen>:
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    26b9:	e8 81 12 00 00       	call   393f <mkdir>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    26d1:	e8 69 12 00 00       	call   393f <mkdir>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    26ee:	e8 24 12 00 00       	call   3917 <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    2701:	50                   	push   %eax
    2702:	e8 f8 11 00 00       	call   38ff <close>
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    2707:	58                   	pop    %eax
    2708:	5a                   	pop    %edx
    2709:	6a 00                	push   $0x0
    270b:	68 c8 51 00 00       	push   $0x51c8
    2710:	e8 02 12 00 00       	call   3917 <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    271f:	50                   	push   %eax
    2720:	e8 da 11 00 00       	call   38ff <close>
  if(mkdir("12345678901234/12345678901234") == 0){
    2725:	c7 04 24 3c 49 00 00 	movl   $0x493c,(%esp)
    272c:	e8 0e 12 00 00       	call   393f <mkdir>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    2740:	e8 fa 11 00 00       	call   393f <mkdir>
  ...
  printf(1, "fourteen ok\n");
    ...
    exit();
    276e:	e8 64 11 00 00       	call   38d7 <exit>
    ...
    exit();
    2781:	e8 51 11 00 00       	call   38d7 <exit>
    ...
    exit();
    2794:	e8 3e 11 00 00       	call   38d7 <exit>
    ...
    exit();
    27a7:	e8 2b 11 00 00       	call   38d7 <exit>
    ...
    exit();
    27ba:	e8 18 11 00 00       	call   38d7 <exit>
    ...
    exit();
    27cd:	e8 05 11 00 00       	call   38d7 <exit>
...
000027e0 <rmdot>:
{
  ...
  if(mkdir("dots") != 0){
    ...
    27f9:	e8 41 11 00 00       	call   393f <mkdir>
  ...
  if(chdir("dots") != 0){
    ...
    2811:	e8 31 11 00 00       	call   3947 <chdir>
  ...
  if(unlink(".") == 0){
    ...
    2829:	e8 f9 10 00 00       	call   3927 <unlink>
  ...
  if(unlink("..") == 0){
    ...
    2841:	e8 e1 10 00 00       	call   3927 <unlink>
  ...
  if(chdir("/") != 0){
    ...
    2859:	e8 e9 10 00 00       	call   3947 <chdir>
  ...
  if(unlink("dots/.") == 0){
    ...
    2871:	e8 b1 10 00 00       	call   3927 <unlink>
  ...
  if(unlink("dots/..") == 0){
    ...
    2885:	e8 9d 10 00 00       	call   3927 <unlink>
  ...
  if(unlink("dots") != 0){
    ...
    2899:	e8 89 10 00 00       	call   3927 <unlink>
  ...
  printf(1, "rmdot ok\n");
    ...
    exit();
    28c7:	e8 0b 10 00 00       	call   38d7 <exit>
    ...
    exit();
    28da:	e8 f8 0f 00 00       	call   38d7 <exit>
    ...
    exit();
    28ed:	e8 e5 0f 00 00       	call   38d7 <exit>
    printf(1, "unlink dots/. worked!\n");
    28f2:	51                   	push   %ecx
    28f3:	51                   	push   %ecx
    ...
    exit();
    2900:	e8 d2 0f 00 00       	call   38d7 <exit>
    printf(1, "chdir / failed\n");
    2905:	50                   	push   %eax
    2906:	50                   	push   %eax
    ...
    exit();
    2913:	e8 bf 0f 00 00       	call   38d7 <exit>
    printf(1, "rm .. worked!\n");
    2918:	50                   	push   %eax
    2919:	50                   	push   %eax
    ...
    exit();
    2926:	e8 ac 0f 00 00       	call   38d7 <exit>
    printf(1, "rm . worked!\n");
    292b:	50                   	push   %eax
    292c:	50                   	push   %eax
    ...
    exit();
    2939:	e8 99 0f 00 00       	call   38d7 <exit>
    ...
    exit();
    294c:	e8 86 0f 00 00       	call   38d7 <exit>
...
00002960 <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    297f:	e8 93 0f 00 00       	call   3917 <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    2992:	50                   	push   %eax
    2993:	e8 67 0f 00 00       	call   38ff <close>
  if(chdir("dirfile") == 0){
    2998:	c7 04 24 25 4a 00 00 	movl   $0x4a25,(%esp)
    299f:	e8 a3 0f 00 00       	call   3947 <chdir>
  ...
  fd = open("dirfile/xx", 0);
    ...
    29b9:	e8 59 0f 00 00       	call   3917 <open>
  if(fd >= 0){
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    29d6:	e8 3c 0f 00 00       	call   3917 <open>
  if(fd >= 0){
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    29ee:	e8 4c 0f 00 00       	call   393f <mkdir>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    2a06:	e8 1c 0f 00 00       	call   3927 <unlink>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    2a23:	e8 0f 0f 00 00       	call   3937 <link>
  ...
  if(unlink("dirfile") != 0){
    ...
    2a3b:	e8 e7 0e 00 00       	call   3927 <unlink>
  ...
  fd = open(".", O_RDWR);
    ...
    2a55:	e8 bd 0e 00 00       	call   3917 <open>
  if(fd >= 0){
  ...
  fd = open(".", 0);
    ...
    2a6f:	e8 a3 0e 00 00       	call   3917 <open>
  if(write(fd, "x", 1) > 0){
  ...
  if(write(fd, "x", 1) > 0){
    ...
    2a80:	50                   	push   %eax
    2a81:	e8 71 0e 00 00       	call   38f7 <write>
  ...
  close(fd);
    ...
    2a90:	53                   	push   %ebx
    2a91:	e8 69 0e 00 00       	call   38ff <close>
  printf(1, "dir vs file OK\n");
    ...
    exit();
    2aba:	e8 18 0e 00 00       	call   38d7 <exit>
    ...
    exit();
    2acd:	e8 05 0e 00 00       	call   38d7 <exit>
    ...
    exit();
    2ae0:	e8 f2 0d 00 00       	call   38d7 <exit>
    ...
    exit();
    2af3:	e8 df 0d 00 00       	call   38d7 <exit>
    ...
    exit();
    2b06:	e8 cc 0d 00 00       	call   38d7 <exit>
    ...
    exit();
    2b19:	e8 b9 0d 00 00       	call   38d7 <exit>
    ...
    exit();
    2b2c:	e8 a6 0d 00 00       	call   38d7 <exit>
    ...
    exit();
    2b3f:	e8 93 0d 00 00       	call   38d7 <exit>
    ...
    exit();
    2b52:	e8 80 0d 00 00       	call   38d7 <exit>
    ...
    2b64:	bb 33 00 00 00       	mov    $0x33,%ebx
{
  ...
  printf(1, "empty file name\n");
    ...
    2b88:	e8 b2 0d 00 00       	call   393f <mkdir>
    ...
    2ba0:	e8 a2 0d 00 00       	call   3947 <chdir>
  ...
  chdir("/");
    ...
    2c38:	e8 0a 0d 00 00       	call   3947 <chdir>
  printf(1, "empty file name OK\n");
    ...
    2c5d:	e8 ee 0d 00 00       	call   3a50 <printf>
      exit();
    2c62:	e8 70 0c 00 00       	call   38d7 <exit>
    ...
    2c71:	e8 da 0d 00 00       	call   3a50 <printf>
      exit();
    2c76:	e8 5c 0c 00 00       	call   38d7 <exit>
    2c7b:	90                   	nop
    ...
    2c84:	31 db                	xor    %ebx,%ebx
{
  ...
  for(n=0; n<1000; n++){
    ...
    pid = fork();
    2cad:	e8 1d 0c 00 00       	call   38cf <fork>
    if(pid < 0)
  ...
  for(; n > 0; n--){
    ...
    if(wait() < 0){
    2cc0:	e8 1a 0c 00 00       	call   38df <wait>
  ...
  if(wait() != -1){
    2cce:	e8 0c 0c 00 00       	call   38df <wait>
  ...
  printf(1, "fork test OK\n");
    ...
    exit();
    2cff:	e8 d3 0b 00 00       	call   38d7 <exit>
      exit();
    2d04:	e8 ce 0b 00 00       	call   38d7 <exit>
    ...
    2d13:	e8 38 0d 00 00       	call   3a50 <printf>
      exit();
    2d18:	e8 ba 0b 00 00       	call   38d7 <exit>
    ...
    exit();
    2d2b:	e8 a7 0b 00 00       	call   38d7 <exit>
    ...
    2d36:	31 ff                	xor    %edi,%edi
{
  ...
  a = sbrk(0);
    ...
    2d75:	6a 01                	push   $0x1
    2d77:	e8 e3 0b 00 00       	call   395f <sbrk>
    if(b != a){
  ...
  pid = fork();
    2d98:	e8 32 0b 00 00       	call   38cf <fork>
  if(pid < 0){
  ...
  c = sbrk(1);
    2dad:	6a 01                	push   $0x1
    2daf:	e8 ab 0b 00 00       	call   395f <sbrk>
  c = sbrk(1);
    2db4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2dbb:	e8 9f 0b 00 00       	call   395f <sbrk>
  if(c != a + 1){
  ...
  wait();
    2dd3:	e8 07 0b 00 00       	call   38df <wait>
  a = sbrk(0);
    2dd8:	83 ec 0c             	sub    $0xc,%esp
    2ddb:	6a 00                	push   $0x0
    2ddd:	e8 7d 0b 00 00       	call   395f <sbrk>
  ...
  p = sbrk(amt);
    ...
    2dee:	e8 6c 0b 00 00       	call   395f <sbrk>
  if (p != a) {
  ...
  *lastaddr = 99;
  ...
  a = sbrk(0);
    2e08:	6a 00                	push   $0x0
    2e0a:	e8 50 0b 00 00       	call   395f <sbrk>
  c = sbrk(-4096);
    2e0f:	c7 04 24 00 f0 ff ff 	movl   $0xfffff000,(%esp)
  a = sbrk(0);
    2e16:	89 c6                	mov    %eax,%esi
  c = sbrk(-4096);
    2e18:	e8 42 0b 00 00       	call   395f <sbrk>
  ...
  c = sbrk(0);
    ...
    2e2c:	6a 00                	push   $0x0
    2e2e:	e8 2c 0b 00 00       	call   395f <sbrk>
  if(c != a - 4096){
  ...
  a = sbrk(0);
    ...
    2e47:	6a 00                	push   $0x0
    2e49:	e8 11 0b 00 00       	call   395f <sbrk>
    2e4e:	89 c6                	mov    %eax,%esi
  c = sbrk(4096);
    2e50:	c7 04 24 00 10 00 00 	movl   $0x1000,(%esp)
    2e57:	e8 03 0b 00 00       	call   395f <sbrk>
  ...
  if(c != a || sbrk(0) != a + 4096){
    ...
    2e6c:	6a 00                	push   $0x0
    2e6e:	e8 ec 0a 00 00       	call   395f <sbrk>
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    ppid = getpid();
    2ec5:	e8 8d 0a 00 00       	call   3957 <getpid>
    2eca:	89 c7                	mov    %eax,%edi
    pid = fork();
    2ecc:	e8 fe 09 00 00       	call   38cf <fork>
    if(pid < 0){
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    wait();
    2ee5:	e8 f5 09 00 00       	call   38df <wait>
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
  ...
  if(pipe(fds) != 0){
    ...
    2ef8:	50                   	push   %eax
    2ef9:	e8 e9 09 00 00       	call   38e7 <pipe>
    ...
    2f21:	e8 c9 09 00 00       	call   38ef <read>
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    if((pids[i] = fork()) == 0){
    2f33:	e8 97 09 00 00       	call   38cf <fork>
  ...
  c = sbrk(4096);
    ...
    2f9f:	50                   	push   %eax
    2fa0:	e8 62 09 00 00       	call   3907 <kill>
    wait();
    2fa5:	e8 35 09 00 00       	call   38df <wait>
  ...
  if(sbrk(0) > oldbrk)
    ...
    2fbd:	6a 00                	push   $0x0
    2fbf:	e8 9b 09 00 00       	call   395f <sbrk>
  ...
  printf(stdout, "sbrk test OK\n");
    ...
    2fd3:	ff 35 7c 5e 00 00    	pushl  0x5e7c
    ...
    2ff4:	ff 35 7c 5e 00 00    	pushl  0x5e7c
    2ffa:	e8 51 0a 00 00       	call   3a50 <printf>
      exit();
    2fff:	83 c4 20             	add    $0x20,%esp
    3002:	e8 d0 08 00 00       	call   38d7 <exit>
    sbrk(-(sbrk(0) - oldbrk));
    3007:	83 ec 0c             	sub    $0xc,%esp
    300a:	6a 00                	push   $0x0
    300c:	e8 4e 09 00 00       	call   395f <sbrk>
    3011:	29 c3                	sub    %eax,%ebx
    3013:	89 1c 24             	mov    %ebx,(%esp)
    3016:	e8 44 09 00 00       	call   395f <sbrk>
    ...
    3027:	ff 35 7c 5e 00 00    	pushl  0x5e7c
    302d:	e8 1e 0a 00 00       	call   3a50 <printf>
    exit();
    3032:	e8 a0 08 00 00       	call   38d7 <exit>
    printf(1, "pipe() failed\n");
    3037:	52                   	push   %edx
    3038:	52                   	push   %edx
...
00003150 <validatetest>:
{
  ...
  printf(stdout, "validate test\n");
    ...
    317e:	6a 00                	push   $0x0
    3180:	e8 e2 07 00 00       	call   3967 <sleep>
    sleep(0);
    3185:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
    318c:	e8 d6 07 00 00       	call   3967 <sleep>
    kill(pid);
    3191:	89 34 24             	mov    %esi,(%esp)
    3194:	e8 6e 07 00 00       	call   3907 <kill>
    wait();
    3199:	e8 41 07 00 00       	call   38df <wait>
    if(link("nosuchfile", (char*)p) != -1){
    319e:	58                   	pop    %eax
    319f:	5a                   	pop    %edx
    31a0:	53                   	push   %ebx
    31a1:	68 5d 4c 00 00       	push   $0x4c5d
    31a6:	e8 8c 07 00 00       	call   3937 <link>
  ...
  printf(stdout, "validate ok\n");
    ...
    31c9:	ff 35 7c 5e 00 00    	pushl  0x5e7c
    ...
    31dd:	c3                   	ret    
      exit();
    31de:	e8 f4 06 00 00       	call   38d7 <exit>
      printf(stdout, "link should not succeed\n");
    31e3:	83 ec 08             	sub    $0x8,%esp
    31e6:	68 68 4c 00 00       	push   $0x4c68
    31eb:	ff 35 7c 5e 00 00    	pushl  0x5e7c
    31f1:	e8 5a 08 00 00       	call   3a50 <printf>
      exit();
    31f6:	e8 dc 06 00 00       	call   38d7 <exit>
    31fb:	90                   	nop
...
00003200 <bsstest>:
{
  ...
  printf(stdout, "bss test\n");
    ...
    320b:	ff 35 7c 5e 00 00    	pushl  0x5e7c
    3211:	e8 3a 08 00 00       	call   3a50 <printf>
    if(uninit[i] != '\0'){
    3216:	83 c4 10             	add    $0x10,%esp
    3219:	80 3d 40 5f 00 00 00 	cmpb   $0x0,0x5f40
  ...
  for(i = 0; i < sizeof(uninit); i++){
    ...
    if(uninit[i] != '\0'){
    3230:	80 b8 40 5f 00 00 00 	cmpb   $0x0,0x5f40(%eax)
  ...
  printf(stdout, "bss test ok\n");
    ...
    324b:	ff 35 7c 5e 00 00    	pushl  0x5e7c
    ...
    3263:	ff 35 7c 5e 00 00    	pushl  0x5e7c
    3269:	e8 e2 07 00 00       	call   3a50 <printf>
      exit();
    326e:	e8 64 06 00 00       	call   38d7 <exit>
...
00003280 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    328b:	e8 97 06 00 00       	call   3927 <unlink>
  pid = fork();
    3290:	e8 3a 06 00 00       	call   38cf <fork>
  if(pid == 0){
  ...
  wait();
    32a2:	e8 38 06 00 00       	call   38df <wait>
  fd = open("bigarg-ok", 0);
    32a7:	83 ec 08             	sub    $0x8,%esp
    32aa:	6a 00                	push   $0x0
    32ac:	68 b6 4c 00 00       	push   $0x4cb6
    32b1:	e8 61 06 00 00       	call   3917 <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    32c4:	50                   	push   %eax
    32c5:	e8 35 06 00 00       	call   38ff <close>
  unlink("bigarg-ok");
    32ca:	c7 04 24 b6 4c 00 00 	movl   $0x4cb6,(%esp)
    32d1:	e8 51 06 00 00       	call   3927 <unlink>
}
    32d6:	83 c4 10             	add    $0x10,%esp
    32d9:	c9                   	leave  
    32da:	c3                   	ret    
    32db:	b8 a0 5e 00 00       	mov    $0x5ea0,%eax
      args[i] = "bigargs test: failed\n                                                                                                                                                                                                       ";
    32e0:	c7 00 10 54 00 00    	movl   $0x5410,(%eax)
    32e6:	83 c0 04             	add    $0x4,%eax
    for(i = 0; i < MAXARG-1; i++)
    32e9:	3d 1c 5f 00 00       	cmp    $0x5f1c,%eax
    32ee:	75 f0                	jne    32e0 <bigargtest+0x60>
    printf(stdout, "bigarg test\n");
    32f0:	51                   	push   %ecx
    32f1:	51                   	push   %ecx
    32f2:	68 c0 4c 00 00       	push   $0x4cc0
    32f7:	ff 35 7c 5e 00 00    	pushl  0x5e7c
    args[MAXARG-1] = 0;
    32fd:	c7 05 1c 5f 00 00 00 	movl   $0x0,0x5f1c
    3304:	00 00 00 
    printf(stdout, "bigarg test\n");
    ...
    330c:	58                   	pop    %eax
    330d:	5a                   	pop    %edx
    330e:	68 a0 5e 00 00       	push   $0x5ea0
    3313:	68 8d 3e 00 00       	push   $0x3e8d
    3318:	e8 f2 05 00 00       	call   390f <exec>
    printf(stdout, "bigarg test ok\n");
    331d:	59                   	pop    %ecx
    331e:	58                   	pop    %eax
    331f:	68 cd 4c 00 00       	push   $0x4ccd
    3324:	ff 35 7c 5e 00 00    	pushl  0x5e7c
    ...
    333b:	e8 d7 05 00 00       	call   3917 <open>
    close(fd);
    3340:	89 04 24             	mov    %eax,(%esp)
    3343:	e8 b7 05 00 00       	call   38ff <close>
    exit();
    3348:	e8 8a 05 00 00       	call   38d7 <exit>
    printf(stdout, "bigarg test failed!\n");
    334d:	50                   	push   %eax
    334e:	50                   	push   %eax
    334f:	68 f6 4c 00 00       	push   $0x4cf6
    3354:	ff 35 7c 5e 00 00    	pushl  0x5e7c
    335a:	e8 f1 06 00 00       	call   3a50 <printf>
    exit();
    335f:	e8 73 05 00 00       	call   38d7 <exit>
    printf(stdout, "bigargtest: fork failed\n");
    3364:	52                   	push   %edx
    3365:	52                   	push   %edx
    3366:	68 dd 4c 00 00       	push   $0x4cdd
    336b:	ff 35 7c 5e 00 00    	pushl  0x5e7c
    3371:	e8 da 06 00 00       	call   3a50 <printf>
    exit();
    3376:	e8 5c 05 00 00       	call   38d7 <exit>
    337b:	90                   	nop
    ...
    3386:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "fsfull test\n");
    ...
    342a:	50                   	push   %eax
    342b:	e8 e7 04 00 00       	call   3917 <open>
    if(fd < 0){
    ...
    344a:	68 60 86 00 00       	push   $0x8660
    344f:	57                   	push   %edi
    3450:	e8 a2 04 00 00       	call   38f7 <write>
      if(cc < 512)
    ...
    3472:	e8 88 04 00 00       	call   38ff <close>
    if(total == 0)
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    3519:	50                   	push   %eax
    351a:	e8 08 04 00 00       	call   3927 <unlink>
  while(nfiles >= 0){
...
00003550 <uio>:
{
  ...
  pid = fork();
    3562:	e8 68 03 00 00       	call   38cf <fork>
  if(pid == 0){
  ...
  wait();
    3570:	e8 6a 03 00 00       	call   38df <wait>
  printf(1, "uio test done\n");
    ...
    exit();
    35a8:	e8 2a 03 00 00       	call   38d7 <exit>
    printf (1, "fork failed\n");
    35ad:	50                   	push   %eax
    35ae:	50                   	push   %eax
    ...
    exit();
    35bb:	e8 17 03 00 00       	call   38d7 <exit>
...
000035c0 <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    35ce:	e8 44 03 00 00       	call   3917 <open>
  if (fd < 0) {
  ...
  read(fd, sbrk(0) - 1, -1);
    ...
    35df:	6a 00                	push   $0x0
    35e1:	e8 79 03 00 00       	call   395f <sbrk>
    35e6:	83 c4 0c             	add    $0xc,%esp
    35e9:	83 e8 01             	sub    $0x1,%eax
    35ec:	6a ff                	push   $0xffffffff
    35ee:	50                   	push   %eax
    35ef:	53                   	push   %ebx
    35f0:	e8 fa 02 00 00       	call   38ef <read>
  close(fd);
    35f5:	89 1c 24             	mov    %ebx,(%esp)
    35f8:	e8 02 03 00 00       	call   38ff <close>
  printf(1, "arg test passed\n");
    ...
    exit();
    3621:	e8 b1 02 00 00       	call   38d7 <exit>
    3626:	8d 76 00             	lea    0x0(%esi),%esi
    3629:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi

00003630 <rand>:
  randstate = randstate * 1664525 + 1013904223;
    3630:	69 05 78 5e 00 00 0d 	imul   $0x19660d,0x5e78,%eax
    3637:	66 19 00 
{
    363a:	55                   	push   %ebp
  ...
  randstate = randstate * 1664525 + 1013904223;
    ...
    3643:	a3 78 5e 00 00       	mov    %eax,0x5e78
}
    3648:	c3                   	ret    
    ...
    3768:	89 f3                	mov    %esi,%ebx
{
  ...
  for(i=0; i+1 < max; ){
    ...
    3780:	50                   	push   %eax
    3781:	6a 00                	push   $0x0
    3783:	e8 67 01 00 00       	call   38ef <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
  ...
  fd = open(n, O_RDONLY);
    ...
    37ed:	e8 25 01 00 00       	call   3917 <open>
  if(fd < 0)
  ...
  r = fstat(fd, st);
    ...
    3801:	50                   	push   %eax
    3802:	e8 28 01 00 00       	call   392f <fstat>
  close(fd);
    3807:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
    380a:	89 c6                	mov    %eax,%esi
  close(fd);
    380c:	e8 ee 00 00 00       	call   38ff <close>
  return r;
...
void delay(int numberOfClocks)
{
    ...
    38a3:	53                   	push   %ebx
    38a4:	83 ec 04             	sub    $0x4,%esp
    int firstClock = uptime();
    38a7:	e8 c3 00 00 00       	call   396f <uptime>
    38ac:	89 c3                	mov    %eax,%ebx
    int incClock = uptime();
    38ae:	e8 bc 00 00 00       	call   396f <uptime>
    while(incClock >= (firstClock + numberOfClocks) )
    38b3:	03 5d 08             	add    0x8(%ebp),%ebx
    38b6:	39 d8                	cmp    %ebx,%eax
    38b8:	7c 0f                	jl     38c9 <delay+0x29>
    38ba:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    {
        incClock = uptime();
    38c0:	e8 aa 00 00 00       	call   396f <uptime>
    while(incClock >= (firstClock + numberOfClocks) )
    38c5:	39 d8                	cmp    %ebx,%eax
    38c7:	7d f7                	jge    38c0 <delay+0x20>
    }
}
    38c9:	83 c4 04             	add    $0x4,%esp
    38cc:	5b                   	pop    %ebx
    38cd:	5d                   	pop    %ebp
    38ce:	c3                   	ret    
...
SYSCALL(fork)
    38cf:	b8 01 00 00 00       	mov    $0x1,%eax
    38d4:	cd 40                	int    $0x40
    38d6:	c3                   	ret    

000038d7 <exit>:
SYSCALL(exit)
    38d7:	b8 02 00 00 00       	mov    $0x2,%eax
    38dc:	cd 40                	int    $0x40
    38de:	c3                   	ret    

000038df <wait>:
SYSCALL(wait)
    38df:	b8 03 00 00 00       	mov    $0x3,%eax
    38e4:	cd 40                	int    $0x40
    38e6:	c3                   	ret    

000038e7 <pipe>:
SYSCALL(pipe)
    38e7:	b8 04 00 00 00       	mov    $0x4,%eax
    38ec:	cd 40                	int    $0x40
    38ee:	c3                   	ret    

000038ef <read>:
SYSCALL(read)
    38ef:	b8 05 00 00 00       	mov    $0x5,%eax
    38f4:	cd 40                	int    $0x40
    38f6:	c3                   	ret    

000038f7 <write>:
SYSCALL(write)
    38f7:	b8 10 00 00 00       	mov    $0x10,%eax
    38fc:	cd 40                	int    $0x40
    38fe:	c3                   	ret    

000038ff <close>:
SYSCALL(close)
    38ff:	b8 15 00 00 00       	mov    $0x15,%eax
    3904:	cd 40                	int    $0x40
    3906:	c3                   	ret    

00003907 <kill>:
SYSCALL(kill)
    3907:	b8 06 00 00 00       	mov    $0x6,%eax
    390c:	cd 40                	int    $0x40
    390e:	c3                   	ret    

0000390f <exec>:
SYSCALL(exec)
    390f:	b8 07 00 00 00       	mov    $0x7,%eax
    3914:	cd 40                	int    $0x40
    3916:	c3                   	ret    

00003917 <open>:
SYSCALL(open)
    3917:	b8 0f 00 00 00       	mov    $0xf,%eax
    391c:	cd 40                	int    $0x40
    391e:	c3                   	ret    

0000391f <mknod>:
SYSCALL(mknod)
    391f:	b8 11 00 00 00       	mov    $0x11,%eax
    3924:	cd 40                	int    $0x40
    3926:	c3                   	ret    

00003927 <unlink>:
SYSCALL(unlink)
    3927:	b8 12 00 00 00       	mov    $0x12,%eax
    392c:	cd 40                	int    $0x40
    392e:	c3                   	ret    

0000392f <fstat>:
SYSCALL(fstat)
    392f:	b8 08 00 00 00       	mov    $0x8,%eax
    3934:	cd 40                	int    $0x40
    3936:	c3                   	ret    

00003937 <link>:
SYSCALL(link)
    3937:	b8 13 00 00 00       	mov    $0x13,%eax
    393c:	cd 40                	int    $0x40
    393e:	c3                   	ret    

0000393f <mkdir>:
SYSCALL(mkdir)
    393f:	b8 14 00 00 00       	mov    $0x14,%eax
    3944:	cd 40                	int    $0x40
    3946:	c3                   	ret    

00003947 <chdir>:
SYSCALL(chdir)
    3947:	b8 09 00 00 00       	mov    $0x9,%eax
    394c:	cd 40                	int    $0x40
    394e:	c3                   	ret    

0000394f <dup>:
SYSCALL(dup)
    394f:	b8 0a 00 00 00       	mov    $0xa,%eax
    3954:	cd 40                	int    $0x40
    3956:	c3                   	ret    

00003957 <getpid>:
SYSCALL(getpid)
    3957:	b8 0b 00 00 00       	mov    $0xb,%eax
    395c:	cd 40                	int    $0x40
    395e:	c3                   	ret    

0000395f <sbrk>:
SYSCALL(sbrk)
    395f:	b8 0c 00 00 00       	mov    $0xc,%eax
    3964:	cd 40                	int    $0x40
    3966:	c3                   	ret    

00003967 <sleep>:
SYSCALL(sleep)
    3967:	b8 0d 00 00 00       	mov    $0xd,%eax
    396c:	cd 40                	int    $0x40
    396e:	c3                   	ret    

0000396f <uptime>:
SYSCALL(uptime)
    396f:	b8 0e 00 00 00       	mov    $0xe,%eax
    3974:	cd 40                	int    $0x40
    3976:	c3                   	ret    

00003977 <incNum>:
SYSCALL(incNum)
    3977:	b8 16 00 00 00       	mov    $0x16,%eax
    397c:	cd 40                	int    $0x40
    397e:	c3                   	ret    

0000397f <getprocs>:
SYSCALL(getprocs)
    397f:	b8 17 00 00 00       	mov    $0x17,%eax
    3984:	cd 40                	int    $0x40
    3986:	c3                   	ret    

00003987 <set_burst_time>:
SYSCALL(set_burst_time)
    3987:	b8 18 00 00 00       	mov    $0x18,%eax
    398c:	cd 40                	int    $0x40
    398e:	c3                   	ret    

0000398f <set_priority>:
SYSCALL(set_priority)
    398f:	b8 19 00 00 00       	mov    $0x19,%eax
    3994:	cd 40                	int    $0x40
    3996:	c3                   	ret    

00003997 <set_lottery_ticket>:
SYSCALL(set_lottery_ticket)
    3997:	b8 1a 00 00 00       	mov    $0x1a,%eax
    399c:	cd 40                	int    $0x40
    399e:	c3                   	ret    

0000399f <set_sched_queue>:
SYSCALL(set_sched_queue)
    399f:	b8 1b 00 00 00       	mov    $0x1b,%eax
    39a4:	cd 40                	int    $0x40
    39a6:	c3                   	ret    

000039a7 <show_processes_scheduling>:
SYSCALL(show_processes_scheduling)
    39a7:	b8 1c 00 00 00       	mov    $0x1c,%eax
    39ac:	cd 40                	int    $0x40
    39ae:	c3                   	ret    
    39af:	90                   	nop
    ...
    39b9:	85 d2                	test   %edx,%edx
{
  ...
  write(fd, &c, 1);
    ...
    3a20:	e8 d2 fe ff ff       	call   38f7 <write>
...
printf(int fd, const char *fmt, ...)
{
  ...
  write(fd, &c, 1);
    ...
    3a90:	e8 62 fe ff ff       	call   38f7 <write>
  ...
  write(fd, &c, 1);
    ...
    3af1:	e8 01 fe ff ff       	call   38f7 <write>
  ...
  write(fd, &c, 1);
    3b0a:	e8 e8 fd ff ff       	call   38f7 <write>
  for(i = 0; fmt[i]; i++){
  ...
  write(fd, &c, 1);
    ...
    3ba3:	57                   	push   %edi
    3ba4:	53                   	push   %ebx
    3ba5:	e8 4d fd ff ff       	call   38f7 <write>
        while(*s != 0){
  ...
  write(fd, &c, 1);
    ...
    3bf7:	e8 fb fc ff ff       	call   38f7 <write>
        ap++;
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    3c21:	a1 20 5f 00 00       	mov    0x5f20,%eax
{
  ...
  freep = p;
    3c5f:	a3 20 5f 00 00       	mov    %eax,0x5f20
}
    3c64:	5b                   	pop    %ebx
    3c65:	5e                   	pop    %esi
    3c66:	5f                   	pop    %edi
    ...
    3c76:	72 ce                	jb     3c46 <free+0x26>
{
  ...
  freep = p;
    3c9a:	a3 20 5f 00 00       	mov    %eax,0x5f20
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    3cbc:	8b 15 20 5f 00 00    	mov    0x5f20,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  return freep;
    3d2b:	8b 15 20 5f 00 00    	mov    0x5f20,%edx
    ...
    3d54:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
    3d57:	89 15 20 5f 00 00    	mov    %edx,0x5f20
}
    ...
    base.s.ptr = freep = prevp = &base;
    3d70:	c7 05 20 5f 00 00 24 	movl   $0x5f24,0x5f20
    3d77:	5f 00 00 
    3d7a:	c7 05 24 5f 00 00 24 	movl   $0x5f24,0x5f24
    3d81:	5f 00 00 
    base.s.size = 0;
    3d84:	b8 24 5f 00 00       	mov    $0x5f24,%eax
    3d89:	c7 05 28 5f 00 00 00 	movl   $0x0,0x5f28
    3d90:	00 00 00 
