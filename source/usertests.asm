...
00000120 <iputtest>:
{
  ...
  printf(stdout, "iput test\n");
     ...
     12b:	ff 35 8c 5e 00 00    	pushl  0x5e8c
  ...
  printf(stdout, "iput test ok\n");
     ...
     191:	ff 35 8c 5e 00 00    	pushl  0x5e8c
    ...
    printf(stdout, "mkdir failed\n");
     ...
     1a8:	ff 35 8c 5e 00 00    	pushl  0x5e8c
    ...
    printf(stdout, "chdir / failed\n");
     ...
     1bf:	ff 35 8c 5e 00 00    	pushl  0x5e8c
    ...
    printf(stdout, "unlink ../iputdir failed\n");
     ...
     1d6:	ff 35 8c 5e 00 00    	pushl  0x5e8c
    ...
    printf(stdout, "chdir iputdir failed\n");
     ...
     1ed:	ff 35 8c 5e 00 00    	pushl  0x5e8c
...
00000200 <exitiputtest>:
{
  ...
  printf(stdout, "exitiput test\n");
     ...
     20b:	ff 35 8c 5e 00 00    	pushl  0x5e8c
  ...
  printf(stdout, "exitiput test ok\n");
     ...
     27d:	ff 35 8c 5e 00 00    	pushl  0x5e8c
     ...
     298:	ff 35 8c 5e 00 00    	pushl  0x5e8c
    ...
    printf(stdout, "fork failed\n");
     ...
     2af:	ff 35 8c 5e 00 00    	pushl  0x5e8c
    ...
    exit();
     ...
     2c6:	ff 35 8c 5e 00 00    	pushl  0x5e8c
     ...
     2dd:	ff 35 8c 5e 00 00    	pushl  0x5e8c
...
000002f0 <openiputtest>:
{
  ...
  printf(stdout, "openiput test\n");
     ...
     2fb:	ff 35 8c 5e 00 00    	pushl  0x5e8c
  ...
  if(pid == 0){
    ...
    if(fd >= 0){
     ...
     34a:	ff 35 8c 5e 00 00    	pushl  0x5e8c
  ...
  printf(stdout, "openiput test ok\n");
     ...
     38a:	ff 35 8c 5e 00 00    	pushl  0x5e8c
    ...
    printf(stdout, "mkdir oidir failed\n");
     ...
     3ac:	ff 35 8c 5e 00 00    	pushl  0x5e8c
    ...
    printf(stdout, "fork failed\n");
     ...
     3c3:	ff 35 8c 5e 00 00    	pushl  0x5e8c
    ...
    printf(stdout, "unlink failed\n");
     ...
     3da:	ff 35 8c 5e 00 00    	pushl  0x5e8c
...
000003f0 <opentest>:
{
  ...
  printf(stdout, "open test\n");
     ...
     3fb:	ff 35 8c 5e 00 00    	pushl  0x5e8c
  ...
  printf(stdout, "open test ok\n");
     ...
     441:	ff 35 8c 5e 00 00    	pushl  0x5e8c
    ...
    printf(stdout, "open echo failed!\n");
     ...
     458:	ff 35 8c 5e 00 00    	pushl  0x5e8c
    ...
    printf(stdout, "open doesnotexist succeeded!\n");
     ...
     46f:	ff 35 8c 5e 00 00    	pushl  0x5e8c
...
00000480 <writetest>:
{
  ...
  printf(stdout, "small file test\n");
     ...
     48d:	ff 35 8c 5e 00 00    	pushl  0x5e8c
  ...
  for(i = 0; i < 100; i++){
    ...
    printf(stdout, "creat small succeeded; ok\n");
     ...
     4c0:	ff 35 8c 5e 00 00    	pushl  0x5e8c
  ...
  printf(stdout, "writes ok\n");
     ...
     518:	ff 35 8c 5e 00 00    	pushl  0x5e8c
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open small succeeded ok\n");
     ...
     54e:	ff 35 8c 5e 00 00    	pushl  0x5e8c
  ...
  if(i == 2000){
    ...
    printf(stdout, "read succeeded ok\n");
     ...
     582:	ff 35 8c 5e 00 00    	pushl  0x5e8c
  ...
  printf(stdout, "small file test ok\n");
     ...
     5b0:	ff 35 8c 5e 00 00    	pushl  0x5e8c
     ...
     5ce:	ff 35 8c 5e 00 00    	pushl  0x5e8c
     ...
     5e7:	ff 35 8c 5e 00 00    	pushl  0x5e8c
    ...
    printf(stdout, "error: open small failed!\n");
     ...
     5fe:	ff 35 8c 5e 00 00    	pushl  0x5e8c
    ...
    printf(stdout, "read failed\n");
     ...
     615:	ff 35 8c 5e 00 00    	pushl  0x5e8c
    ...
    printf(stdout, "unlink small failed\n");
     ...
     62c:	ff 35 8c 5e 00 00    	pushl  0x5e8c
    ...
    printf(stdout, "error: creat small failed!\n");
     ...
     643:	ff 35 8c 5e 00 00    	pushl  0x5e8c
...
00000660 <writetest1>:
{
  ...
  printf(stdout, "big files test\n");
     ...
     66d:	ff 35 8c 5e 00 00    	pushl  0x5e8c
  ...
  printf(stdout, "big files ok\n");
     ...
     765:	ff 35 8c 5e 00 00    	pushl  0x5e8c
     ...
     783:	ff 35 8c 5e 00 00    	pushl  0x5e8c
     ...
     79a:	ff 35 8c 5e 00 00    	pushl  0x5e8c
     ...
     7b3:	ff 35 8c 5e 00 00    	pushl  0x5e8c
     ...
     7ce:	ff 35 8c 5e 00 00    	pushl  0x5e8c
    ...
    printf(stdout, "error: open big failed!\n");
     ...
     7e5:	ff 35 8c 5e 00 00    	pushl  0x5e8c
    ...
    printf(stdout, "error: creat big failed!\n");
     ...
     7fc:	ff 35 8c 5e 00 00    	pushl  0x5e8c
    ...
    printf(stdout, "unlink big failed\n");
     ...
     813:	ff 35 8c 5e 00 00    	pushl  0x5e8c
     ...
     834:	bb 30 00 00 00       	mov    $0x30,%ebx
{
  ...
  printf(stdout, "many creates, followed by unlink test\n");
     ...
     841:	ff 35 8c 5e 00 00    	pushl  0x5e8c
  ...
  printf(stdout, "many creates, followed by unlink; ok\n");
     ...
     8c6:	ff 35 8c 5e 00 00    	pushl  0x5e8c
...
000008e0 <dirtest>:
{
  ...
  printf(stdout, "mkdir test\n");
     ...
     8eb:	ff 35 8c 5e 00 00    	pushl  0x5e8c
  ...
  printf(stdout, "mkdir test ok\n");
     ...
     951:	ff 35 8c 5e 00 00    	pushl  0x5e8c
    ...
    printf(stdout, "mkdir failed\n");
     ...
     968:	ff 35 8c 5e 00 00    	pushl  0x5e8c
    ...
    printf(stdout, "unlink dir0 failed\n");
     ...
     97f:	ff 35 8c 5e 00 00    	pushl  0x5e8c
    ...
    printf(stdout, "chdir .. failed\n");
     ...
     996:	ff 35 8c 5e 00 00    	pushl  0x5e8c
    ...
    printf(stdout, "chdir dir0 failed\n");
     ...
     9ad:	ff 35 8c 5e 00 00    	pushl  0x5e8c
...
000009c0 <exectest>:
{
  ...
  printf(stdout, "exec test\n");
     ...
     9cb:	ff 35 8c 5e 00 00    	pushl  0x5e8c
     9d1:	e8 8a 30 00 00       	call   3a60 <printf>
  if(exec("echo", echoargv) < 0){
     9d6:	5a                   	pop    %edx
     9d7:	59                   	pop    %ecx
     9d8:	68 90 5e 00 00       	push   $0x5e90
    ...
    printf(stdout, "exec echo failed\n");
     ...
     9f7:	ff 35 8c 5e 00 00    	pushl  0x5e8c
    ...
    2d36:	31 ff                	xor    %edi,%edi
{
  ...
  printf(stdout, "sbrk test\n");
    ...
    2d40:	ff 35 8c 5e 00 00    	pushl  0x5e8c
  ...
  *lastaddr = 99;
  ...
  printf(stdout, "sbrk test OK\n");
    ...
    2fd3:	ff 35 8c 5e 00 00    	pushl  0x5e8c
    ...
    2ff4:	ff 35 8c 5e 00 00    	pushl  0x5e8c
    ...
    3027:	ff 35 8c 5e 00 00    	pushl  0x5e8c
    ...
    3054:	ff 35 8c 5e 00 00    	pushl  0x5e8c
    ...
    3073:	ff 35 8c 5e 00 00    	pushl  0x5e8c
    ...
    308a:	ff 35 8c 5e 00 00    	pushl  0x5e8c
    ...
    30a1:	ff 35 8c 5e 00 00    	pushl  0x5e8c
    ...
    30b8:	ff 35 8c 5e 00 00    	pushl  0x5e8c
    ...
    30cf:	ff 35 8c 5e 00 00    	pushl  0x5e8c
    ...
    30e6:	ff 35 8c 5e 00 00    	pushl  0x5e8c
    ...
    30fd:	ff 35 8c 5e 00 00    	pushl  0x5e8c
    ...
    3119:	ff 35 8c 5e 00 00    	pushl  0x5e8c
    ...
    3130:	ff 35 8c 5e 00 00    	pushl  0x5e8c
...
00003150 <validatetest>:
{
  ...
  printf(stdout, "validate test\n");
    ...
    315f:	ff 35 8c 5e 00 00    	pushl  0x5e8c
  ...
  printf(stdout, "validate ok\n");
    ...
    31c9:	ff 35 8c 5e 00 00    	pushl  0x5e8c
    ...
    31eb:	ff 35 8c 5e 00 00    	pushl  0x5e8c
...
00003200 <bsstest>:
{
  ...
  printf(stdout, "bss test\n");
    ...
    320b:	ff 35 8c 5e 00 00    	pushl  0x5e8c
  ...
  printf(stdout, "bss test ok\n");
    ...
    324b:	ff 35 8c 5e 00 00    	pushl  0x5e8c
    ...
    3263:	ff 35 8c 5e 00 00    	pushl  0x5e8c
...
00003280 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    32f7:	ff 35 8c 5e 00 00    	pushl  0x5e8c
    args[MAXARG-1] = 0;
    ...
    3324:	ff 35 8c 5e 00 00    	pushl  0x5e8c
    ...
    3354:	ff 35 8c 5e 00 00    	pushl  0x5e8c
    ...
    336b:	ff 35 8c 5e 00 00    	pushl  0x5e8c
...
00003630 <rand>:
  randstate = randstate * 1664525 + 1013904223;
    3630:	69 05 88 5e 00 00 0d 	imul   $0x19660d,0x5e88,%eax
    3637:	66 19 00 
{
    363a:	55                   	push   %ebp
  ...
  randstate = randstate * 1664525 + 1013904223;
    ...
    3643:	a3 88 5e 00 00       	mov    %eax,0x5e88
}
    3648:	c3                   	ret    
...
000039af <getNumFreePages>:
    39af:	b8 1d 00 00 00       	mov    $0x1d,%eax
    39b4:	cd 40                	int    $0x40
    39b6:	c3                   	ret    
    ...
    39c9:	85 d2                	test   %edx,%edx
{
  ...
  write(fd, &c, 1);
    ...
    3a30:	e8 c2 fe ff ff       	call   38f7 <write>
...
printf(int fd, const char *fmt, ...)
{
  ...
  write(fd, &c, 1);
    ...
    3aa0:	e8 52 fe ff ff       	call   38f7 <write>
  ...
  write(fd, &c, 1);
    ...
    3b01:	e8 f1 fd ff ff       	call   38f7 <write>
  ...
  write(fd, &c, 1);
    3b1a:	e8 d8 fd ff ff       	call   38f7 <write>
  for(i = 0; fmt[i]; i++){
  ...
  write(fd, &c, 1);
    ...
    3bb3:	57                   	push   %edi
    3bb4:	53                   	push   %ebx
    3bb5:	e8 3d fd ff ff       	call   38f7 <write>
        while(*s != 0){
  ...
  write(fd, &c, 1);
    ...
    3c07:	e8 eb fc ff ff       	call   38f7 <write>
        ap++;
...
malloc(uint nbytes)
{
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    3d1e:	56                   	push   %esi
    3d1f:	e8 3b fc ff ff       	call   395f <sbrk>
  if(p == (char*)-1)
