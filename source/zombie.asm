 ...
 399:	85 d2                	test   %edx,%edx
{
 ...
 400:	e8 d2 fe ff ff       	call   2d7 <write>
...
printf(int fd, const char *fmt, ...)
{
 ...
 470:	e8 62 fe ff ff       	call   2d7 <write>
 ...
 4d1:	e8 01 fe ff ff       	call   2d7 <write>
 ...
 4e8:	31 ff                	xor    %edi,%edi
  write(fd, &c, 1);
 4ea:	e8 e8 fd ff ff       	call   2d7 <write>
  for(i = 0; fmt[i]; i++){
 ...
 583:	57                   	push   %edi
 584:	53                   	push   %ebx
 585:	e8 4d fd ff ff       	call   2d7 <write>
        while(*s != 0){
 ...
 5d7:	e8 fb fc ff ff       	call   2d7 <write>
        ap++;
...
malloc(uint nbytes)
{
 ...
 6ee:	56                   	push   %esi
 6ef:	e8 4b fc ff ff       	call   33f <sbrk>
  if(p == (char*)-1)
