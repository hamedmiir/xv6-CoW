...
main(void)
{
  ...
  if(fork() > 0)
  11:	e8 99 02 00 00       	call   2af <fork>
  16:	85 c0                	test   %eax,%eax
  18:	7e 0d                	jle    27 <main+0x27>
    sleep(5);  // Let child exit before parent.
  1a:	83 ec 0c             	sub    $0xc,%esp
  1d:	6a 05                	push   $0x5
  1f:	e8 23 03 00 00       	call   347 <sleep>
  24:	83 c4 10             	add    $0x10,%esp
  exit();
  27:	e8 8b 02 00 00       	call   2b7 <exit>
  2c:	66 90                	xchg   %ax,%ax
  2e:	66 90                	xchg   %ax,%ax
 ...
 148:	89 f3                	mov    %esi,%ebx
{
 ...
 160:	50                   	push   %eax
 161:	6a 00                	push   $0x0
 163:	e8 67 01 00 00       	call   2cf <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 1cd:	e8 25 01 00 00       	call   2f7 <open>
  if(fd < 0)
 ...
 1e1:	50                   	push   %eax
 1e2:	e8 28 01 00 00       	call   30f <fstat>
  close(fd);
 1e7:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 1ea:	89 c6                	mov    %eax,%esi
  close(fd);
 1ec:	e8 ee 00 00 00       	call   2df <close>
  return r;
...
void delay(int numberOfClocks)
{
 ...
 287:	e8 c3 00 00 00       	call   34f <uptime>
 28c:	89 c3                	mov    %eax,%ebx
    int incClock = uptime();
 28e:	e8 bc 00 00 00       	call   34f <uptime>
    while(incClock >= (firstClock + numberOfClocks) )
 293:	03 5d 08             	add    0x8(%ebp),%ebx
 296:	39 d8                	cmp    %ebx,%eax
 298:	7c 0f                	jl     2a9 <delay+0x29>
 29a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    {
        incClock = uptime();
 2a0:	e8 aa 00 00 00       	call   34f <uptime>
    while(incClock >= (firstClock + numberOfClocks) )
 2a5:	39 d8                	cmp    %ebx,%eax
 2a7:	7d f7                	jge    2a0 <delay+0x20>
    }
}
 ...
 3a9:	85 d2                	test   %edx,%edx
{
 ...
 410:	e8 c2 fe ff ff       	call   2d7 <write>
...
printf(int fd, const char *fmt, ...)
{
 ...
 480:	e8 52 fe ff ff       	call   2d7 <write>
 ...
 4e1:	e8 f1 fd ff ff       	call   2d7 <write>
 ...
 4f8:	31 ff                	xor    %edi,%edi
  write(fd, &c, 1);
 4fa:	e8 d8 fd ff ff       	call   2d7 <write>
  for(i = 0; fmt[i]; i++){
 ...
 593:	57                   	push   %edi
 594:	53                   	push   %ebx
 595:	e8 3d fd ff ff       	call   2d7 <write>
        while(*s != 0){
 ...
 5e7:	e8 eb fc ff ff       	call   2d7 <write>
        ap++;
 ...
 611:	a1 68 0a 00 00       	mov    0xa68,%eax
{
 ...
 64d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 64f:	a3 68 0a 00 00       	mov    %eax,0xa68
}
 654:	5b                   	pop    %ebx
 655:	5e                   	pop    %esi
 656:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 6a9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6ac:	8b 15 68 0a 00 00    	mov    0xa68,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6fe:	56                   	push   %esi
 6ff:	e8 3b fc ff ff       	call   33f <sbrk>
  if(p == (char*)-1)
 ...
 767:	0a 00 00 
 76a:	c7 05 6c 0a 00 00 6c 	movl   $0xa6c,0xa6c
 771:	0a 00 00 
    base.s.size = 0;
 774:	b8 6c 0a 00 00       	mov    $0xa6c,%eax
 779:	c7 05 70 0a 00 00 00 	movl   $0x0,0xa70
 780:	00 00 00 
